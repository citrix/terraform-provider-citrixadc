...
# Data Source: vpnglobal_authenticationldappolicy_binding

The vpnglobal_authenticationldappolicy_binding data source allows you to retrieve information about a vpnglobal authenticationldappolicy binding.
...
output "priority" {
  value = data.citrixadc_vpnglobal_authenticationldappolicy_binding.tf_bind.priority
}

output "groupextraction" {
  value = data.citrixadc_vpnglobal_authenticationldappolicy_binding.tf_bind.groupextraction
}
```
