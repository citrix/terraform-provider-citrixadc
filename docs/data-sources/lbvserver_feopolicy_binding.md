...
# Data Source: lbvserver_feopolicy_binding

The lbvserver_feopolicy_binding data source allows you to retrieve information about the binding between a load balancing virtual server and a front end optimization policy.

## Example Usage

```terraform
data "citrixadc_lbvserver_feopolicy_binding" "tf_binding" {
  name       = "tf_lbvserver"
  policyname = "tf_feopolicy"
}

output "gotopriorityexpression" {
  value = data.citrixadc_lbvserver_feopolicy_binding.tf_binding.gotopriorityexpression
}

output "order" {
  value = data.citrixadc_lbvserver_feopolicy_binding.tf_binding.order
}
```
...
* `id` - The id of the lbvserver_feopolicy_binding. It is a system-generated identifier.
