...
# Data Source: vpnglobal_auditsyslogpolicy_binding

The vpnglobal_auditsyslogpolicy_binding data source allows you to retrieve information about an auditsyslogpolicy binding to vpnglobal configuration.
...
data "citrixadc_vpnglobal_auditsyslogpolicy_binding" "tf_bind" {
  policyname = "new_auditsyslogpolicy"
}

output "policyname" {
  value = data.citrixadc_vpnglobal_auditsyslogpolicy_binding.tf_bind.policyname
}

output "priority" {
  value = data.citrixadc_vpnglobal_auditsyslogpolicy_binding.tf_bind.priority
}
```
...
* `id` - The id of the vpnglobal_auditsyslogpolicy_binding. It is a system-generated identifier.
