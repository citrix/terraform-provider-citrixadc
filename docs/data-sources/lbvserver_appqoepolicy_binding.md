...
```terraform
data "citrixadc_lbvserver_appqoepolicy_binding" "tf_bind" {
  name       = "tf_lbvserver"
  policyname = "tf_appqoe_policy"
}

output "gotopriorityexpression" {
  value = data.citrixadc_lbvserver_appqoepolicy_binding.tf_bind.gotopriorityexpression
}

output "priority" {
  value = data.citrixadc_lbvserver_appqoepolicy_binding.tf_bind.priority
}
```
