...
# Data Source: vpnvserver_rewritepolicy_binding

The vpnvserver_rewritepolicy_binding data source allows you to retrieve information about a vpnvserver_rewritepolicy_binding configuration.
...
data "citrixadc_vpnvserver_rewritepolicy_binding" "tf_bind" {
  ...
  policy    = "tf_test_rewrite_policy"
  bindpoint = "REQUEST"
}

output "priority" {
  value = data.citrixadc_vpnvserver_rewritepolicy_binding.tf_bind.priority
}

output "gotopriorityexpression" {
  value = data.citrixadc_vpnvserver_rewritepolicy_binding.tf_bind.gotopriorityexpression
}
```
...
* `id` - The id of the vpnvserver_rewritepolicy_binding. It is the concatenation of the `name` and `policy` attributes separated by a comma.
