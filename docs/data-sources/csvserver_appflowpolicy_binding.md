...
# Data Source: csvserver_appflowpolicy_binding

The csvserver_appflowpolicy_binding data source allows you to retrieve information about the binding between a content switching virtual server and an AppFlow policy.

## Example Usage

```terraform
data "citrixadc_csvserver_appflowpolicy_binding" "tf_binding" {
  name       = "tf_csvserver"
  policyname = "tf_appflowpolicy"
}

output "labelname" {
  value = data.citrixadc_csvserver_appflowpolicy_binding.tf_binding.labelname
}

output "gotopriorityexpression" {
  value = data.citrixadc_csvserver_appflowpolicy_binding.tf_binding.gotopriorityexpression
}

output "labeltype" {
  value = data.citrixadc_csvserver_appflowpolicy_binding.tf_binding.labeltype
}
```
