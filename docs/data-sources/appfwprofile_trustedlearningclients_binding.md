...
* `id` - The id of the appfwprofile_trustedlearningclients_binding. It is the concatenation of the `name` and `trustedlearningclients` attributes separated by a comma.
