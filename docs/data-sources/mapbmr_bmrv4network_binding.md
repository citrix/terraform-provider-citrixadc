...
* `network` - (Required) IPv4 NAT address range of Customer Edge (CE).
...
* `id` - The id of the mapbmr_bmrv4network_binding. It is the concatenation of `name` and `network` attributes separated by a comma.
