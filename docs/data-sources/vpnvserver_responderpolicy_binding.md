...
# Data Source: vpnvserver_responderpolicy_binding

The vpnvserver_responderpolicy_binding data source allows you to retrieve information about a responderpolicy binding to a vpnvserver.
...
output "priority" {
  value = data.citrixadc_vpnvserver_responderpolicy_binding.tf_bind.priority
}

output "bindpoint" {
  value = data.citrixadc_vpnvserver_responderpolicy_binding.tf_bind.bindpoint
}
```
