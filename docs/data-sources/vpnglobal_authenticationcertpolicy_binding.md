...
# Data Source: vpnglobal_authenticationcertpolicy_binding

The vpnglobal_authenticationcertpolicy_binding data source allows you to retrieve information about a vpnglobal authenticationcertpolicy binding.

## Example Usage

```terraform
data "citrixadc_vpnglobal_authenticationcertpolicy_binding" "tf_bind" {
  policyname = "tf_certpolicy"
}

output "priority" {
  value = data.citrixadc_vpnglobal_authenticationcertpolicy_binding.tf_bind.priority
}

output "groupextraction" {
  value = data.citrixadc_vpnglobal_authenticationcertpolicy_binding.tf_bind.groupextraction
}
```
