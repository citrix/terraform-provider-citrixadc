...
The vrid6_channel_binding data source allows you to retrieve information about a channel interface bound to an IPv6 Virtual Router ID (VRID6), including the read-only flags and VLAN reported by the Citrix ADC.
