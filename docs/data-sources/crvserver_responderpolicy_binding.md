...
# Data Source: crvserver_responderpolicy_binding

The crvserver_responderpolicy_binding data source allows you to retrieve information about a specific binding between a cache redirection virtual server and a responder policy.
...
data "citrixadc_crvserver_responderpolicy_binding" "crvserver_responderpolicy_binding" {
  name       = "my_vserver"
  policyname = "my_responder_policy"
}

output "vserver_name" {
  value = data.citrixadc_crvserver_responderpolicy_binding.crvserver_responderpolicy_binding.name
}

output "policy_name" {
  value = data.citrixadc_crvserver_responderpolicy_binding.crvserver_responderpolicy_binding.policyname
}

output "priority" {
  value = data.citrixadc_crvserver_responderpolicy_binding.crvserver_responderpolicy_binding.priority
}
```
