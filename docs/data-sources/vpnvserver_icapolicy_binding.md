...
output "bindpoint" {
  value = data.citrixadc_vpnvserver_icapolicy_binding.tf_binding.gotopriorityexpression
}
```
...
* `id` - The id of the vpnvserver_icapolicy_binding. It is a system-generated identifier.
