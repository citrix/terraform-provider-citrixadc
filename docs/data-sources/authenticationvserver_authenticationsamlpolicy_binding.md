...
output "priority" {
  value = data.citrixadc_authenticationvserver_authenticationsamlpolicy_binding.tf_bind.priority
}

output "bindpoint" {
  value = data.citrixadc_authenticationvserver_authenticationsamlpolicy_binding.tf_bind.bindpoint
}
```
