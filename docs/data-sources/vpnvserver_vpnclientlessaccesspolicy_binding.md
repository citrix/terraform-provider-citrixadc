...
# Data Source: vpnvserver_vpnclientlessaccesspolicy_binding
...
data "citrixadc_vpnvserver_vpnclientlessaccesspolicy_binding" "tf_bind" {
  name   = "tf_example"
  policy = "tf_vpnclientlessaccesspolicy"
}

output "priority" {
  value = data.citrixadc_vpnvserver_vpnclientlessaccesspolicy_binding.tf_bind.priority
}
