...
```terraform
data "citrixadc_contentinspectioncallout" "tf_contentinspectioncallout" {
  name = "my_ci_callout"
}

output "type" {
  value = data.citrixadc_contentinspectioncallout.tf_contentinspectioncallout.type
}

output "profilename" {
  value = data.citrixadc_contentinspectioncallout.tf_contentinspectioncallout.profilename
}

output "serverip" {
  value = data.citrixadc_contentinspectioncallout.tf_contentinspectioncallout.serverip
}
```
