...
# Data Source: vpnglobal_vpnsessionpolicy_binding

The vpnglobal_vpnsessionpolicy_binding data source allows you to retrieve information about a vpn session policy binding to the global configuration.
...
data "citrixadc_vpnglobal_vpnsessionpolicy_binding" "tf_bind" {
  policyname = "tf_vpnsessionpolicy"
}

output "policyname" {
  value = data.citrixadc_vpnglobal_vpnsessionpolicy_binding.tf_bind.policyname
}

output "priority" {
  value = data.citrixadc_vpnglobal_vpnsessionpolicy_binding.tf_bind.priority
}
```
...
* `id` - The id of the vpnglobal_vpnsessionpolicy_binding. It is a system-generated identifier.
