...
```terraform
data "citrixadc_sslservice_sslcertkey_binding" "tf_binding" {
...
output "ocspcheck" {
  value = data.citrixadc_sslservice_sslcertkey_binding.tf_binding.ocspcheck
}

output "skipcaname" {
  value = data.citrixadc_sslservice_sslcertkey_binding.tf_binding.skipcaname
}
```
