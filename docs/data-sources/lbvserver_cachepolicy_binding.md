...
# Data Source: lbvserver_cachepolicy_binding

The lbvserver_cachepolicy_binding data source allows you to retrieve information about the binding between a load balancing virtual server and a cache policy.
...
* `id` - The id of the lbvserver_cachepolicy_binding. It is a system-generated identifier.
