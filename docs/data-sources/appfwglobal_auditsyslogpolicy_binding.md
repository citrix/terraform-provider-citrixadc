...
# Data Source: appfwglobal_auditsyslogpolicy_binding

The appfwglobal_auditsyslogpolicy_binding data source allows you to retrieve information about the binding between auditsyslogpolicy and appfwglobal configuration.
...
output "state" {
  value = data.citrixadc_appfwglobal_auditsyslogpolicy_binding.tf_binding.state
}

output "policyname" {
  value = data.citrixadc_appfwglobal_auditsyslogpolicy_binding.tf_binding.policyname
}
```
