...
# Data Source: lsngroup_lsnappsprofile_binding

The lsngroup_lsnappsprofile_binding data source allows you to retrieve information about an LSN group to LSN application profile binding.

## Example Usage

```terraform
data "citrixadc_lsngroup_lsnappsprofile_binding" "tf_binding" {
  groupname       = "my_lsn_group"
  appsprofilename = "my_lsn_profile"
}

output "groupname" {
  value = data.citrixadc_lsngroup_lsnappsprofile_binding.tf_binding.groupname
}

output "appsprofilename" {
  value = data.citrixadc_lsngroup_lsnappsprofile_binding.tf_binding.appsprofilename
}
```
