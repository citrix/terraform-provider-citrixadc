...
output "groupname" {
  value = data.citrixadc_lsngroup_lsnpool_binding.tf_lsngroup_lsnpool_binding.groupname
}

output "poolname" {
  value = data.citrixadc_lsngroup_lsnpool_binding.tf_lsngroup_lsnpool_binding.poolname
}
```
...
* `id` - The id of the lsngroup_lsnpool_binding. It is a system-generated identifier.
