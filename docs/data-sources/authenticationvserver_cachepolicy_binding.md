...
# Data Source: authenticationvserver_cachepolicy_binding

The authenticationvserver_cachepolicy_binding data source allows you to retrieve information about the binding between an authentication virtual server and a cache policy.
...
output "priority" {
  value = data.citrixadc_authenticationvserver_cachepolicy_binding.tf_binding.priority
}

output "gotopriorityexpression" {
  value = data.citrixadc_authenticationvserver_cachepolicy_binding.tf_binding.gotopriorityexpression
}
```
