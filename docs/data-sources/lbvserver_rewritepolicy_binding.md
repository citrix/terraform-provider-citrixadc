...
output "labeltype" {
  value = data.citrixadc_lbvserver_rewritepolicy_binding.tf_bind.labeltype
}
```
...
* `id` - The id of the lbvserver_rewritepolicy_binding. It is a system-generated identifier.
