...
# Data Source: lbvserver_rewritepolicy_binding

The lbvserver_rewritepolicy_binding data source allows you to retrieve information about the binding between a load balancing virtual server and a rewrite policy.
...
output "gotopriorityexpression" {
  value = data.citrixadc_lbvserver_rewritepolicy_binding.tf_bind.gotopriorityexpression
}

output "priority" {
  value = data.citrixadc_lbvserver_rewritepolicy_binding.tf_bind.priority
}
```
...
* `id` - The id of the lbvserver_rewritepolicy_binding. It is the concatenation of the `name` and `policyname` attributes separated by a comma.
