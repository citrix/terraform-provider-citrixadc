...
output "gotopriorityexpression" {
  value = data.citrixadc_lbvserver_spilloverpolicy_binding.tf_lbvserver_spilloverpolicy_binding.gotopriorityexpression
}

output "invoke" {
  value = data.citrixadc_lbvserver_spilloverpolicy_binding.tf_lbvserver_spilloverpolicy_binding.invoke
}
```
...
* `id` - The id of the lbvserver_spilloverpolicy_binding. It is a system-generated identifier.
