...
# Data Source: lsnappsprofile_port_binding

The lsnappsprofile_port_binding data source allows you to retrieve information about a specific LSN application profile port binding.
...
output "appsprofilename" {
  value = data.citrixadc_lsnappsprofile_port_binding.tf_lsnappsprofile_port_binding.appsprofilename
}

output "lsnport" {
  value = data.citrixadc_lsnappsprofile_port_binding.tf_lsnappsprofile_port_binding.lsnport
}
```
