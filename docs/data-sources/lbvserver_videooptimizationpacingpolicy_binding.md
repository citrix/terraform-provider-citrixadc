...
# Data Source: lbvserver_videooptimizationpacingpolicy_binding

The lbvserver_videooptimizationpacingpolicy_binding data source allows you to retrieve information about a video optimization pacing policy binding to a load balancing virtual server.

## Example Usage

```terraform
data "citrixadc_lbvserver_videooptimizationpacingpolicy_binding" "tf_binding" {
  name       = "tf_lbvserver"
...
output "gotopriorityexpression" {
  value = data.citrixadc_lbvserver_videooptimizationpacingpolicy_binding.tf_binding.gotopriorityexpression
}

output "order" {
  value = data.citrixadc_lbvserver_videooptimizationpacingpolicy_binding.tf_binding.order
}
```
...
* `bindpoint` - (Required) The bindpoint to which the policy is bound. Possible values: [ REQUEST, RESPONSE ]
...
* `priority` - Priority.
* `id` - The id of the lbvserver_videooptimizationpacingpolicy_binding. It is a system-generated identifier.
