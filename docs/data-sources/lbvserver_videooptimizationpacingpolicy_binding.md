...
The lbvserver_videooptimizationpacingpolicy_binding data source allows you to retrieve information about the binding between a load balancing virtual server and a video optimization pacing policy.


## Example Usage

```terraform
data "citrixadc_lbvserver_videooptimizationpacingpolicy_binding" "tf_bind" {
  name       = "tf_lbvserver"
...
output "gotopriorityexpression" {
  value = data.citrixadc_lbvserver_videooptimizationpacingpolicy_binding.tf_bind.gotopriorityexpression
}

output "priority" {
  value = data.citrixadc_lbvserver_videooptimizationpacingpolicy_binding.tf_bind.priority
}
```
