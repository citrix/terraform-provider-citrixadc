...
# Data Source: vpnglobal_vpntrafficpolicy_binding

The vpnglobal_vpntrafficpolicy_binding data source allows you to retrieve information about a vpn traffic policy binding to the global configuration.
...
data "citrixadc_vpnglobal_vpntrafficpolicy_binding" "tf_bind" {
  policyname = "tf_vpntrafficpolicy"
}

output "priority" {
  value = data.citrixadc_vpnglobal_vpntrafficpolicy_binding.tf_bind.priority
}

output "gotopriorityexpression" {
  value = data.citrixadc_vpnglobal_vpntrafficpolicy_binding.tf_bind.gotopriorityexpression
}
```
...
* `id` - The id of the vpnglobal_vpntrafficpolicy_binding. It is a system-generated identifier.
