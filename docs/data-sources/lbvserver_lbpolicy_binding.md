...
# Data Source: lbvserver_lbpolicy_binding

The lbvserver_lbpolicy_binding data source allows you to retrieve information about the binding between a load balancing virtual server and a load balancing policy.
...
output "gotopriorityexpression" {
  value = data.citrixadc_lbvserver_lbpolicy_binding.tf_bind.gotopriorityexpression
}

output "order" {
  value = data.citrixadc_lbvserver_lbpolicy_binding.tf_bind.order
}
```
...
* `id` - The id of the lbvserver_lbpolicy_binding. It is the concatenation of the `name` and `policyname` attributes separated by a comma.
