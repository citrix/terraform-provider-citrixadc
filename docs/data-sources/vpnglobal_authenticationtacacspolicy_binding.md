...
# Data Source: vpnglobal_authenticationtacacspolicy_binding

The vpnglobal_authenticationtacacspolicy_binding data source allows you to retrieve information about a vpnglobal_authenticationtacacspolicy_binding.
...
output "policyname" {
  value = data.citrixadc_vpnglobal_authenticationtacacspolicy_binding.tf_bind.policyname
}

output "priority" {
  value = data.citrixadc_vpnglobal_authenticationtacacspolicy_binding.tf_bind.priority
}
```
...
* `id` - The id of the vpnglobal_authenticationtacacspolicy_binding. It is a system-generated identifier.
