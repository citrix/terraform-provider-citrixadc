...
# Data Source: vpnglobal_vpnurlpolicy_binding
...
output "priority" {
  value = data.citrixadc_vpnglobal_vpnurlpolicy_binding.tf_bind.priority
}

output "groupextraction" {
  value = data.citrixadc_vpnglobal_vpnurlpolicy_binding.tf_bind.groupextraction
}
```
