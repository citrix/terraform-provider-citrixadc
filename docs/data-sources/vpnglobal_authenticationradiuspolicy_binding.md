...
# Data Source: vpnglobal_authenticationradiuspolicy_binding

The vpnglobal_authenticationradiuspolicy_binding data source allows you to retrieve information about a vpnglobal authenticationradiuspolicy binding.
...
output "priority" {
  value = data.citrixadc_vpnglobal_authenticationradiuspolicy_binding.tf_bind.priority
}

output "secondary" {
  value = data.citrixadc_vpnglobal_authenticationradiuspolicy_binding.tf_bind.secondary
}
```
