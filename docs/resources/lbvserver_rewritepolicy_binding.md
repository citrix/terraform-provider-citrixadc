...
# Resource: lbvserver_rewritepolicy_binding

The lbvserver_rewritepolicy_binding resource is used to bind a load balancing virtual server to a rewrite policy.
...
A lbvserver_rewritepolicy_binding can be imported using its id, e.g.
