...
The lbvserver_videooptimizationpacingpolicy_binding resource is used to bind load balancing virtual servers to video optimization pacing policies.
...
resource "citrixadc_lbvserver_videooptimizationpacingpolicy_binding" "tf_bind" {
...
A lbvserver_videooptimizationpacingpolicy_binding can be imported using its id, e.g.

```shell
terraform import citrixadc_lbvserver_videooptimizationpacingpolicy_binding.tf_bind tf_lbvserver,tf_pacingpolicy
```
