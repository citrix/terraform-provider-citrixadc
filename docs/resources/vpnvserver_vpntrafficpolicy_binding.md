...
# Resource: vpnvserver_vpntrafficpolicy_binding
...
A vpnvserver_vpntrafficpolicy_binding can be imported using its id, e.g.

```shell
terraform import citrixadc_vpnvserver_vpntrafficpolicy_binding.tf_bind tf_examplevserver,tf_vpntrafficpolicy
```
