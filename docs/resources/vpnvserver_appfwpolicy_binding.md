...
# Resource: vpnvserver_appfwpolicy_binding

The vpnvserver_appfwpolicy_binding resource is used to bind appfwpolicy to vpnvserver.
...
* `id` - The id of the vpnvserver_appfwpolicy_binding. It is the concatenation of the `name` and `policy` attributes separated by a comma.


## Import

A vpnvserver_appfwpolicy_binding can be imported using its id, e.g.
