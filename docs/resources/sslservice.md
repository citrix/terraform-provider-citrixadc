...
* `strictclientekucheck` - (Optional) Enable strict EKU extension check during client authentication. This can be set to DISABLED only for SSL service types Internal and Transparent.
