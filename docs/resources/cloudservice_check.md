...
* `id` - The id of the cloudservice_check resource. It is a synthetic value (`cloudservice_check`), since the NITRO `cloudservice` action exposes no readable object.
