...
# Resource: authenticationvserver_authenticationlocalpolicy_binding
...
A authenticationvserver_authenticationlocalpolicy_binding can be imported using its id, e.g.

```shell
terraform import citrixadc_authenticationvserver_authenticationlocalpolicy_binding.tf_bind tf_authenticationvserver,tf_authenticationlocalpolicy
```
