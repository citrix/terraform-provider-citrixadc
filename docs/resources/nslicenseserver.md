...
* `deviceprofilename` - (Optional) Device profile is created on NetScaler Console and contains the user name and password of the instance(s). NetScaler Console will use this info to add the NS for registration
...
* `password` - (Optional) Password to use when authenticating with NetScaler Console Agent for LAS licensing.
