...
A csvserver_tmtrafficpolicy_binding can be imported using its name, e.g.

```shell
terraform import citrixadc_csvserver_tmtrafficpolicy_binding.tf_csvserver_tmtrafficpolicy_binding tf_csvserver,tf_tmttrafficpolicy
```
