...
* `id` - The id of the aaauser_intranetip_binding. It is the concatenation of  `username` and `intranetip` attributes separated by a comma.
...
```shell
terraform import citrixadc_aaauser_intranetip_binding.tf_aaauser_intranetip_binding user1,10.222.74.158
```
