...
# Resource: aaauser_vpnintranetapplication_binding

The aaauser_vpnintranetapplication_binding resource is used to create aaauser_vpnintranetapplication_binding.
...
A aaauser_vpnintranetapplication_binding can be imported using its name, e.g.
