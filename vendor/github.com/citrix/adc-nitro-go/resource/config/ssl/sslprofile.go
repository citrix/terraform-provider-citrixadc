...
type Sslprofile struct {
	...
	*/
	Sslimaxsessperserver uint32 `json:"sslimaxsessperserver,omitempty"`
	/**
	...
	*/
	Sessionticketlifetime uint32 `json:"sessionticketlifetime,omitempty"`
	/**
	* This option enables the use of session tickets, as per the RFC 5077
	*/
	...
	*/
	Sessionkeylifetime uint32 `json:"sessionkeylifetime,omitempty"`
	/**
	* This option sets the life time of symm key used to generate session tickets issued by NS in secs
	*/
	Prevsessionkeylifetime uint32 `json:"prevsessionkeylifetime,omitempty"`
	/**
