...
type Sslocspresponder struct {
	...
	*/
	Resptimeout uint32 `json:"resptimeout,omitempty"`
	/**
	...
	*/
	Ocspurlresolvetimeout uint32 `json:"ocspurlresolvetimeout,omitempty"`
	...
	*/
	Producedattimeskew uint32 `json:"producedattimeskew,omitempty"`
	/**
