...
type Serverservicegroupbinding struct {
	...
	* port of the service.
	*/
	Dupport int32 `json:"dup_port,omitempty"`
	/**
	* service flags to denote its a db enabled.
	*/
	Svrcfgflags uint32 `json:"svrcfgflags,omitempty"`
	/**
	...
	*/
	Boundtd uint32 `json:"boundtd,omitempty"`
	/**
	...
	*/
	Svcitmpriority uint32 `json:"svcitmpriority,omitempty"`
	/**
	* Indicates the total number of active IPs for SRV target FQDN
	*/
	Svcitmactsvcs uint32 `json:"svcitmactsvcs,omitempty"`
	/**
	* Indicates the total number of bound IPs for the SRV target FQDN
	*/
	Svcitmboundsvcs uint32 `json:"svcitmboundsvcs,omitempty"`
	/**
