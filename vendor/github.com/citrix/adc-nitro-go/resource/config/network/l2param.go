...
type L2param struct {
	...
	*/
	Mbfpeermacupdate uint32 `json:"mbfpeermacupdate,omitempty"`
	/**
	* Maximum bridge collision for loop detection 
	*/
	Maxbridgecollision uint32 `json:"maxbridgecollision,omitempty"`
	/**
	...
	*/
	Bridgeagetimeout uint32 `json:"bridgeagetimeout,omitempty"`
	/**
