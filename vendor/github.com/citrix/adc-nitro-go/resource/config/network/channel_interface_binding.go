...
type Channelinterfacebinding struct {
	...
	*/
	Slavestate uint32 `json:"slavestate,omitempty"`
	/**
	* Media type of the member interfaces.
	*/
	Slavemedia uint32 `json:"slavemedia,omitempty"`
	/**
	* Speed of the member interfaces.
	*/
	Slavespeed uint32 `json:"slavespeed,omitempty"`
	/**
	* Duplex of the member interfaces.
	*/
	Slaveduplex uint32 `json:"slaveduplex,omitempty"`
	/**
	* Flowcontrol of the member interfaces.
	*/
	Slaveflowctl uint32 `json:"slaveflowctl,omitempty"`
	/**
	* UP time of the member interfaces.
	*/
	Slavetime uint32 `json:"slavetime,omitempty"`
	/**
	...
	*/
	Svmcmd uint32 `json:"svmcmd,omitempty"`
	/**
