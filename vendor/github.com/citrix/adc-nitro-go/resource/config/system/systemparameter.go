...
type Systemparameter struct {
	...
	*/
	Natpcbforceflushlimit uint32 `json:"natpcbforceflushlimit,omitempty"`
	/**
	...
	*/
	Minpasswordlen uint32 `json:"minpasswordlen,omitempty"`
	/**
	...
	*/
	Totalauthtimeout uint32 `json:"totalauthtimeout,omitempty"`
	/**
