...
func (r *TmglobalAuditsyslogpolicyBindingResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	tmglobal_auditsyslogpolicy_binding := tmglobal_auditsyslogpolicy_bindingGetThePayloadFromthePlan(ctx, &data)
	...
	if data.Id.IsNull() {
		resp.Diagnostics.AddError("Client Error", "tmglobal_auditsyslogpolicy_binding not found on the ADC immediately after create")
		return
	}
...
func (r *TmglobalAuditsyslogpolicyBindingResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data, state TmglobalAuditsyslogpolicyBindingResourceModel
	...
	if hasChange {
		...
		tflog.Debug(ctx, "No changes detected for tmglobal_auditsyslogpolicy_binding resource, skipping update")
	}
	...
	if data.Id.IsNull() {
		resp.Diagnostics.AddError("Client Error", "tmglobal_auditsyslogpolicy_binding not found on the ADC immediately after update")
		return
	}
...
func (r *TmglobalAuditsyslogpolicyBindingResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	tflog.Trace(ctx, "Deleted tmglobal_auditsyslogpolicy_binding binding")
}
