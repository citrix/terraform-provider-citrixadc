...
// TmglobalAuditsyslogpolicyBindingDataSourceModel is the data-source-specific
// model, decoupled from TmglobalAuditsyslogpolicyBindingResourceModel.
//
...
// declares.
type TmglobalAuditsyslogpolicyBindingDataSourceModel struct {
	...
	// (zion73x_readonly/tmglobal_auditsyslogpolicy_binding.json). Never settable;
	// populated from GET.
	Bindpolicytype types.Int64 `tfsdk:"bindpolicytype"`
}

func TmglobalAuditsyslogpolicyBindingDataSourceSchema() schema.Schema {
...
// tmglobal_auditsyslogpolicy_bindingDataSourceSetAttrFromGet projects a NITRO
// tmglobal_auditsyslogpolicy_binding GET response onto the data-source model. A
...
func tmglobal_auditsyslogpolicy_bindingDataSourceSetAttrFromGet(ctx context.Context, data *TmglobalAuditsyslogpolicyBindingDataSourceModel, g map[string]interface{}) {
	tflog.Debug(ctx, "In tmglobal_auditsyslogpolicy_bindingDataSourceSetAttrFromGet Function")
