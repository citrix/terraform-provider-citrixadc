...
// AuthenticationvserverAuthenticationcertpolicyBindingDataSourceModel is the
...
type AuthenticationvserverAuthenticationcertpolicyBindingDataSourceModel struct {
	...
	// (zion73x_readonly/authenticationvserver_authenticationcertpolicy_binding.json).
	// Never settable; populated from GET.
	Acttype types.Int64 `tfsdk:"acttype"`
}

func AuthenticationvserverAuthenticationcertpolicyBindingDataSourceSchema() schema.Schema {
...
// authenticationvserver_authenticationcertpolicy_bindingDataSourceSetAttrFromGet
...
func authenticationvserver_authenticationcertpolicy_bindingDataSourceSetAttrFromGet(ctx context.Context, data *AuthenticationvserverAuthenticationcertpolicyBindingDataSourceModel, g map[string]interface{}) {
	tflog.Debug(ctx, "In authenticationvserver_authenticationcertpolicy_bindingDataSourceSetAttrFromGet Function")
