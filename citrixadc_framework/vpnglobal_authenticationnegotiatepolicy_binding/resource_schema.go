...
// VpnglobalAuthenticationnegotiatepolicyBindingResourceModel describes the resource data model.
type VpnglobalAuthenticationnegotiatepolicyBindingResourceModel struct {
...
func (r *VpnglobalAuthenticationnegotiatepolicyBindingResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
