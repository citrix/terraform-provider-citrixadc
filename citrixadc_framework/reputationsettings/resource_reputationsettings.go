...
var _ resource.ResourceWithUpgradeState = &ReputationsettingsResource{}
...
func (r *ReputationsettingsResource) UpgradeState(ctx context.Context) map[int64]resource.StateUpgrader {
