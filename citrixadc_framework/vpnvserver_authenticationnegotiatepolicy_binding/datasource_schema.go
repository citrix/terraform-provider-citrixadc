...
// VpnvserverAuthenticationnegotiatepolicyBindingDataSourceModel is the
...
type VpnvserverAuthenticationnegotiatepolicyBindingDataSourceModel struct {
	...
	// (zion73x_readonly/vpnvserver_authenticationnegotiatepolicy_binding.json).
	Acttype types.Int64 `tfsdk:"acttype"`
}

func VpnvserverAuthenticationnegotiatepolicyBindingDataSourceSchema() schema.Schema {
...
// vpnvserver_authenticationnegotiatepolicy_bindingDataSourceSetAttrFromGet projects a
...
func vpnvserver_authenticationnegotiatepolicy_bindingDataSourceSetAttrFromGet(ctx context.Context, data *VpnvserverAuthenticationnegotiatepolicyBindingDataSourceModel, g map[string]interface{}) {
	tflog.Debug(ctx, "In vpnvserver_authenticationnegotiatepolicy_bindingDataSourceSetAttrFromGet Function")
