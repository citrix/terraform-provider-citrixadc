...
// AaauserAuthorizationpolicyBindingDataSourceModel is the data-source-specific
// model, decoupled from AaauserAuthorizationpolicyBindingResourceModel.
//
...
type AaauserAuthorizationpolicyBindingDataSourceModel struct {
	...
	// (zion73x_readonly/aaauser_authorizationpolicy_binding.json). Never
	// settable; populated from GET, null when the appliance omits them.
	Acttype types.Int64 `tfsdk:"acttype"`
}

func AaauserAuthorizationpolicyBindingDataSourceSchema() schema.Schema {
...
// aaauser_authorizationpolicy_bindingDataSourceSetAttrFromGet projects a NITRO
// aaauser_authorizationpolicy_binding GET response onto the data-source model.
// Attributes are simply filled from the GET (or left Null when the GET omits
// them) via the shared utils.MapGet* helpers.
func aaauser_authorizationpolicy_bindingDataSourceSetAttrFromGet(ctx context.Context, data *AaauserAuthorizationpolicyBindingDataSourceModel, g map[string]interface{}) {
	tflog.Debug(ctx, "In aaauser_authorizationpolicy_bindingDataSourceSetAttrFromGet Function")
