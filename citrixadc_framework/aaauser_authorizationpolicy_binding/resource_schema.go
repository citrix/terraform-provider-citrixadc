...
// AaauserAuthorizationpolicyBindingResourceModel describes the resource data model.
type AaauserAuthorizationpolicyBindingResourceModel struct {
...
func (r *AaauserAuthorizationpolicyBindingResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func aaauser_authorizationpolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *AaauserAuthorizationpolicyBindingResourceModel) aaa.Aaauserauthorizationpolicybinding {
	...
	return aaauser_authorizationpolicy_binding
}

func aaauser_authorizationpolicy_bindingSetAttrFromGet(ctx context.Context, data *AaauserAuthorizationpolicyBindingResourceModel, getResponseData map[string]interface{}) *AaauserAuthorizationpolicyBindingResourceModel {
	tflog.Debug(ctx, "In aaauser_authorizationpolicy_bindingSetAttrFromGet Function")
