...
var _ resource.ResourceWithUpgradeState = &RdpserverprofileResource{}
...
func (r *RdpserverprofileResource) UpgradeState(ctx context.Context) map[int64]resource.StateUpgrader {
