...
// AppfwxmlschemaDataSourceModel is the data-source-specific model, decoupled
// from AppfwxmlschemaResourceModel. A data source is a pure read surface, so it
...
type AppfwxmlschemaDataSourceModel struct {
	...
	// (zion73x_readonly/appfwxmlschema.json). Never settable; populated from GET.
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"response": schema.StringAttribute{
				Computed:    true,
				Description: "Response returned by the appliance for the imported XML Schema object.",
			},
		},
	}
}

// appfwxmlschemaDataSourceSetAttrFromGet projects a NITRO appfwxmlschema GET
...
func appfwxmlschemaDataSourceSetAttrFromGet(ctx context.Context, data *AppfwxmlschemaDataSourceModel, g map[string]interface{}) {
	tflog.Debug(ctx, "In appfwxmlschemaDataSourceSetAttrFromGet Function")
