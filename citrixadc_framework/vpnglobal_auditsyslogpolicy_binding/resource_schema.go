...
func vpnglobal_auditsyslogpolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *VpnglobalAuditsyslogpolicyBindingResourceModel) vpn.Vpnglobalauditsyslogpolicybinding {
	tflog.Debug(ctx, "In vpnglobal_auditsyslogpolicy_bindingGetThePayloadFromtheConfig Function")
