...
// AuthenticationvserverAuthenticationlocalpolicyBindingDataSourceModel is the
...
type AuthenticationvserverAuthenticationlocalpolicyBindingDataSourceModel struct {
	...
	// (zion73x_readonly/authenticationvserver_authenticationlocalpolicy_binding.json).
	// Never settable; populated from GET.
	Acttype types.Int64 `tfsdk:"acttype"`
}

func AuthenticationvserverAuthenticationlocalpolicyBindingDataSourceSchema() schema.Schema {
...
// authenticationvserver_authenticationlocalpolicy_bindingDataSourceSetAttrFromGet
...
func authenticationvserver_authenticationlocalpolicy_bindingDataSourceSetAttrFromGet(ctx context.Context, data *AuthenticationvserverAuthenticationlocalpolicyBindingDataSourceModel, g map[string]interface{}) {
	tflog.Debug(ctx, "In authenticationvserver_authenticationlocalpolicy_bindingDataSourceSetAttrFromGet Function")
