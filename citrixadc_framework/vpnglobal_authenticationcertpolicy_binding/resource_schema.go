...
func vpnglobal_authenticationcertpolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *VpnglobalAuthenticationcertpolicyBindingResourceModel) vpn.Vpnglobalauthenticationcertpolicybinding {
	tflog.Debug(ctx, "In vpnglobal_authenticationcertpolicy_bindingGetThePayloadFromtheConfig Function")
