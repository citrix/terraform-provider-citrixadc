...
func vpnvserver_icapolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *VpnvserverIcapolicyBindingResourceModel) vpn.Vpnvservericapolicybinding {
	tflog.Debug(ctx, "In vpnvserver_icapolicy_bindingGetThePayloadFromtheConfig Function")
