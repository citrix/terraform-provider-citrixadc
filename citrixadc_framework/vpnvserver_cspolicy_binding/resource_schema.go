...
func vpnvserver_cspolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *VpnvserverCspolicyBindingResourceModel) vpn.Vpnvservercspolicybinding {
	tflog.Debug(ctx, "In vpnvserver_cspolicy_bindingGetThePayloadFromtheConfig Function")
