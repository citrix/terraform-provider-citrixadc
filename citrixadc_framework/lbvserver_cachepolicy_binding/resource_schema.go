...
func lbvserver_cachepolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *LbvserverCachepolicyBindingResourceModel) lb.Lbvservercachepolicybinding {
	tflog.Debug(ctx, "In lbvserver_cachepolicy_bindingGetThePayloadFromtheConfig Function")
