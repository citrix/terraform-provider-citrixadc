...
// VpnvserverAuthenticationldappolicyBindingDataSourceModel is the
...
type VpnvserverAuthenticationldappolicyBindingDataSourceModel struct {
	...
	// (zion73x_readonly/vpnvserver_authenticationldappolicy_binding.json).
...
// vpnvserver_authenticationldappolicy_bindingDataSourceSetAttrFromGet projects a
...
func vpnvserver_authenticationldappolicy_bindingDataSourceSetAttrFromGet(ctx context.Context, data *VpnvserverAuthenticationldappolicyBindingDataSourceModel, g map[string]interface{}) {
	tflog.Debug(ctx, "In vpnvserver_authenticationldappolicy_bindingDataSourceSetAttrFromGet Function")
