...
func (r *VpnvserverAuthenticationldappolicyBindingResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err = r.client.DeleteResourceWithArgsMap(service.Vpnvserver_authenticationldappolicy_binding.Type(), name_value, argsMap)
	if err != nil {
...
func (r *VpnvserverAuthenticationldappolicyBindingResource) readVpnvserverAuthenticationldappolicyBindingFromApi(ctx context.Context, data *VpnvserverAuthenticationldappolicyBindingResourceModel, diags *diag.Diagnostics) {
	...
	// Resource is missing
	if len(dataArr) == 0 {
		diags.AddError("Client Error", "vpnvserver_authenticationldappolicy_binding returned empty array.")
		return
	}
	...
	//  Resource is missing
	if foundIndex == -1 {
		diags.AddError("Client Error", fmt.Sprintf("vpnvserver_authenticationldappolicy_binding not found with the provided ID attributes"))
		return
	}
