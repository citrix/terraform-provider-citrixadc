...
func (r *MapbmrBmrv4networkBindingResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if data.Id.IsNull() {
		resp.Diagnostics.AddError("Client Error", "mapbmr_bmrv4network_binding not found on the ADC immediately after create")
		return
	}
...
func (r *MapbmrBmrv4networkBindingResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if data.Id.IsNull() {
		resp.Diagnostics.AddError("Client Error", "mapbmr_bmrv4network_binding not found on the ADC immediately after update")
		return
	}
