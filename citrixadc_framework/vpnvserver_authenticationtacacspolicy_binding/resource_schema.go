...
func vpnvserver_authenticationtacacspolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *VpnvserverAuthenticationtacacspolicyBindingResourceModel) vpn.Vpnvserverauthenticationtacacspolicybinding {
	tflog.Debug(ctx, "In vpnvserver_authenticationtacacspolicy_bindingGetThePayloadFromtheConfig Function")
