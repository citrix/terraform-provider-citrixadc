...
func (r *AppfwgrpcwebjsoncontenttypeResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	r.readAppfwgrpcwebjsoncontenttypeFromApi(ctx, &data, &resp.Diagnostics)
...
func (r *AppfwgrpcwebjsoncontenttypeResource) readAppfwgrpcwebjsoncontenttypeFromApi(ctx context.Context, data *AppfwgrpcwebjsoncontenttypeResourceModel, diags *diag.Diagnostics) {
