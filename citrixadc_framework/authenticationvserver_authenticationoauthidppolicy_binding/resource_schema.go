...
func authenticationvserver_authenticationoauthidppolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *AuthenticationvserverAuthenticationoauthidppolicyBindingResourceModel) authentication.Authenticationvserverauthenticationoauthidppolicybinding {
	tflog.Debug(ctx, "In authenticationvserver_authenticationoauthidppolicy_bindingGetThePayloadFromtheConfig Function")
