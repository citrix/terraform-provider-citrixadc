...
// VideooptimizationglobalpacingVideooptimizationpacingpolicyBindingDataSourceModel
...
type VideooptimizationglobalpacingVideooptimizationpacingpolicyBindingDataSourceModel struct {
	...
	// (zion73x_readonly/videooptimizationglobalpacing_videooptimizationpacingpolicy_binding.json).
	Numpol types.Int64 `tfsdk:"numpol"`
}

func VideooptimizationglobalpacingVideooptimizationpacingpolicyBindingDataSourceSchema() schema.Schema {
...
// videooptimizationglobalpacing_videooptimizationpacingpolicy_bindingDataSourceSetAttrFromGet
// projects a NITRO GET response onto the data-source model using the shared
// utils.MapGet* helpers.
func videooptimizationglobalpacing_videooptimizationpacingpolicy_bindingDataSourceSetAttrFromGet(ctx context.Context, data *VideooptimizationglobalpacingVideooptimizationpacingpolicyBindingDataSourceModel, g map[string]interface{}) {
	tflog.Debug(ctx, "In videooptimizationglobalpacing_videooptimizationpacingpolicy_bindingDataSourceSetAttrFromGet Function")
