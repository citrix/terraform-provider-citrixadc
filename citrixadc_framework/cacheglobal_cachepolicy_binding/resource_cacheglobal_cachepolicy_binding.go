...
func (r *CacheglobalCachepolicyBindingResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if data.Id.IsNull() {
		resp.Diagnostics.AddError("Client Error", "cacheglobal_cachepolicy_binding not found on the ADC immediately after create")
		return
	}
...
func (r *CacheglobalCachepolicyBindingResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if data.Id.IsNull() {
		resp.Diagnostics.AddError("Client Error", "cacheglobal_cachepolicy_binding not found on the ADC immediately after update")
		return
	}
