...
func (r *LbvserverVideooptimizationdetectionpolicyBindingResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if data.Id.IsNull() {
		resp.Diagnostics.AddError("Client Error", "lbvserver_videooptimizationdetectionpolicy_binding not found on the ADC immediately after create")
		return
	}
...
func (r *LbvserverVideooptimizationdetectionpolicyBindingResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data, state LbvserverVideooptimizationdetectionpolicyBindingResourceModel
	...
	if hasChange {
		...
		tflog.Debug(ctx, "No changes detected for lbvserver_videooptimizationdetectionpolicy_binding resource, skipping update")
	}
	...
	if data.Id.IsNull() {
		resp.Diagnostics.AddError("Client Error", "lbvserver_videooptimizationdetectionpolicy_binding not found on the ADC immediately after update")
		return
	}
...
func (r *LbvserverVideooptimizationdetectionpolicyBindingResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to delete lbvserver_videooptimizationdetectionpolicy_binding, got error: %s", err))
		return
	}

	tflog.Trace(ctx, "Deleted lbvserver_videooptimizationdetectionpolicy_binding binding")
}
