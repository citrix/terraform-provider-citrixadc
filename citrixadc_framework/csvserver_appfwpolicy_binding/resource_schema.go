...
func csvserver_appfwpolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *CsvserverAppfwpolicyBindingResourceModel) cs.Csvserverappfwpolicybinding {
	tflog.Debug(ctx, "In csvserver_appfwpolicy_bindingGetThePayloadFromtheConfig Function")
