...
func vpnglobal_authenticationradiuspolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *VpnglobalAuthenticationradiuspolicyBindingResourceModel) vpn.Vpnglobalauthenticationradiuspolicybinding {
	tflog.Debug(ctx, "In vpnglobal_authenticationradiuspolicy_bindingGetThePayloadFromtheConfig Function")
