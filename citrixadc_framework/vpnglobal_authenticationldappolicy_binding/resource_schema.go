...
// VpnglobalAuthenticationldappolicyBindingResourceModel describes the resource data model.
type VpnglobalAuthenticationldappolicyBindingResourceModel struct {
...
func (r *VpnglobalAuthenticationldappolicyBindingResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
