...
func cachepolicylabel_cachepolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *CachepolicylabelCachepolicyBindingResourceModel) cache.Cachepolicylabelcachepolicybinding {
	tflog.Debug(ctx, "In cachepolicylabel_cachepolicy_bindingGetThePayloadFromtheConfig Function")
