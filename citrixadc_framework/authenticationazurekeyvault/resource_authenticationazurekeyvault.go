...
var _ resource.ResourceWithUpgradeState = &AuthenticationazurekeyvaultResource{}
...
func (r *AuthenticationazurekeyvaultResource) UpgradeState(ctx context.Context) map[int64]resource.StateUpgrader {
