...
var _ resource.ResourceWithUpgradeState = &AuthenticationemailactionResource{}
...
func (r *AuthenticationemailactionResource) UpgradeState(ctx context.Context) map[int64]resource.StateUpgrader {
