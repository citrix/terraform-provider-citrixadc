...
// AaauserVpnurlBindingResourceModel describes the resource data model.
type AaauserVpnurlBindingResourceModel struct {
...
func (r *AaauserVpnurlBindingResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func aaauser_vpnurl_bindingGetThePayloadFromtheConfig(ctx context.Context, data *AaauserVpnurlBindingResourceModel) aaa.Aaauservpnurlbinding {
	...
	return aaauser_vpnurl_binding
}

func aaauser_vpnurl_bindingSetAttrFromGet(ctx context.Context, data *AaauserVpnurlBindingResourceModel, getResponseData map[string]interface{}) *AaauserVpnurlBindingResourceModel {
	tflog.Debug(ctx, "In aaauser_vpnurl_bindingSetAttrFromGet Function")
