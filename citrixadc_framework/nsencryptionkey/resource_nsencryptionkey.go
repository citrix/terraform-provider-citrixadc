...
var _ resource.ResourceWithUpgradeState = &NsencryptionkeyResource{}
...
func (r *NsencryptionkeyResource) UpgradeState(ctx context.Context) map[int64]resource.StateUpgrader {
