...
var _ resource.ResourceWithUpgradeState = &AaaradiusparamsResource{}
...
func (r *AaaradiusparamsResource) UpgradeState(ctx context.Context) map[int64]resource.StateUpgrader {
