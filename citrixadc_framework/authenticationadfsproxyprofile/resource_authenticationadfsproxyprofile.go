...
var _ resource.ResourceWithUpgradeState = &AuthenticationadfsproxyprofileResource{}
...
func (r *AuthenticationadfsproxyprofileResource) UpgradeState(ctx context.Context) map[int64]resource.StateUpgrader {
