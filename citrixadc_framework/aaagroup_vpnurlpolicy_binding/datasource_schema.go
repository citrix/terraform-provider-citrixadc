...
// AaagroupVpnurlpolicyBindingDataSourceModel is the data-source-specific model,
...
// Computed.
type AaagroupVpnurlpolicyBindingDataSourceModel struct {
	...
	// (zion73x_readonly/aaagroup_vpnurlpolicy_binding.json).
	Acttype types.Int64 `tfsdk:"acttype"`
}

func AaagroupVpnurlpolicyBindingDataSourceSchema() schema.Schema {
...
// aaagroup_vpnurlpolicy_bindingDataSourceSetAttrFromGet projects a NITRO GET
...
func aaagroup_vpnurlpolicy_bindingDataSourceSetAttrFromGet(ctx context.Context, data *AaagroupVpnurlpolicyBindingDataSourceModel, g map[string]interface{}) {
	tflog.Debug(ctx, "In aaagroup_vpnurlpolicy_bindingDataSourceSetAttrFromGet Function")
