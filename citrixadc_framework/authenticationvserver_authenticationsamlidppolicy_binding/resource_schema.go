...
func authenticationvserver_authenticationsamlidppolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *AuthenticationvserverAuthenticationsamlidppolicyBindingResourceModel) authentication.Authenticationvserverauthenticationsamlidppolicybinding {
	tflog.Debug(ctx, "In authenticationvserver_authenticationsamlidppolicy_bindingGetThePayloadFromtheConfig Function")
