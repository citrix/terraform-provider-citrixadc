...
// AuthenticationvserverAuthenticationsamlidppolicyBindingDataSourceModel is the
...
type AuthenticationvserverAuthenticationsamlidppolicyBindingDataSourceModel struct {
	...
	// (zion73x_readonly/authenticationvserver_authenticationsamlidppolicy_binding.json).
	// Never settable; populated from GET, null when the appliance omits them.
	Acttype types.Int64 `tfsdk:"acttype"`
}

func AuthenticationvserverAuthenticationsamlidppolicyBindingDataSourceSchema() schema.Schema {
...
// authenticationvserver_authenticationsamlidppolicy_bindingDataSourceSetAttrFromGet
...
func authenticationvserver_authenticationsamlidppolicy_bindingDataSourceSetAttrFromGet(ctx context.Context, data *AuthenticationvserverAuthenticationsamlidppolicyBindingDataSourceModel, g map[string]interface{}) {
	tflog.Debug(ctx, "In authenticationvserver_authenticationsamlidppolicy_bindingDataSourceSetAttrFromGet Function")
