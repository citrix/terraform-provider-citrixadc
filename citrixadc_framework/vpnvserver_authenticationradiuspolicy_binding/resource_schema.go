...
func vpnvserver_authenticationradiuspolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *VpnvserverAuthenticationradiuspolicyBindingResourceModel) vpn.Vpnvserverauthenticationradiuspolicybinding {
	tflog.Debug(ctx, "In vpnvserver_authenticationradiuspolicy_bindingGetThePayloadFromtheConfig Function")
