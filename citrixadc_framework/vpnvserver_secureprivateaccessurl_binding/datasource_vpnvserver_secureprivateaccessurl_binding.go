...
func (d *VpnvserverSecureprivateaccessurlBindingDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data VpnvserverSecureprivateaccessurlBindingDataSourceModel
	...
	vpnvserver_secureprivateaccessurl_bindingDataSourceSetAttrFromGet(ctx, &data, dataArr[foundIndex])
