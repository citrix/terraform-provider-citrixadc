...
func lbvserver_authorizationpolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *LbvserverAuthorizationpolicyBindingResourceModel) lb.Lbvserverauthorizationpolicybinding {
	tflog.Debug(ctx, "In lbvserver_authorizationpolicy_bindingGetThePayloadFromtheConfig Function")
