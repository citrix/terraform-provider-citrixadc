...
var _ resource.ResourceWithUpgradeState = &LbparameterResource{}
...
func (r *LbparameterResource) UpgradeState(ctx context.Context) map[int64]resource.StateUpgrader {
