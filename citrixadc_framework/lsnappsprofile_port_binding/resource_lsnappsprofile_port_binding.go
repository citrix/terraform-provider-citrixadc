...
func (r *LsnappsprofilePortBindingResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if data.Id.IsNull() {
		resp.Diagnostics.AddError("Client Error", "lsnappsprofile_port_binding not found on the ADC immediately after create")
		return
	}
...
func (r *LsnappsprofilePortBindingResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if data.Id.IsNull() {
		resp.Diagnostics.AddError("Client Error", "lsnappsprofile_port_binding not found on the ADC immediately after update")
		return
	}
