...
func vpnvserver_authenticationdfapolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *VpnvserverAuthenticationdfapolicyBindingResourceModel) vpn.Vpnvserverauthenticationdfapolicybinding {
	tflog.Debug(ctx, "In vpnvserver_authenticationdfapolicy_bindingGetThePayloadFromtheConfig Function")
