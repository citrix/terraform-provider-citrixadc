...
var _ resource.ResourceWithUpgradeState = &SslecdsakeyResource{}
...
func (r *SslecdsakeyResource) UpgradeState(ctx context.Context) map[int64]resource.StateUpgrader {
