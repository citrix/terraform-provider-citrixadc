...
func clusternodegroup_authenticationvserver_bindingGetThePayloadFromtheConfig(ctx context.Context, data *ClusternodegroupAuthenticationvserverBindingResourceModel) cluster.Clusternodegroupauthenticationvserverbinding {
	tflog.Debug(ctx, "In clusternodegroup_authenticationvserver_bindingGetThePayloadFromtheConfig Function")
