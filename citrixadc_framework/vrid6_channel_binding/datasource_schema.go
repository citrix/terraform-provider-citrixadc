...
// vrid6_channel_bindingDataSourceSetAttrFromGet projects a NITRO
// vrid6_channel_binding GET response onto the data-source model. Because a data
...
func vrid6_channel_bindingDataSourceSetAttrFromGet(ctx context.Context, data *Vrid6ChannelBindingDataSourceModel, g map[string]interface{}) {
	tflog.Debug(ctx, "In vrid6_channel_bindingDataSourceSetAttrFromGet Function")
