...
func vpnvserver_authenticationsamlpolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *VpnvserverAuthenticationsamlpolicyBindingResourceModel) vpn.Vpnvserverauthenticationsamlpolicybinding {
	tflog.Debug(ctx, "In vpnvserver_authenticationsamlpolicy_bindingGetThePayloadFromtheConfig Function")
