...
func vpnvserver_vpnsessionpolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *VpnvserverVpnsessionpolicyBindingResourceModel) vpn.Vpnvservervpnsessionpolicybinding {
	tflog.Debug(ctx, "In vpnvserver_vpnsessionpolicy_bindingGetThePayloadFromtheConfig Function")
