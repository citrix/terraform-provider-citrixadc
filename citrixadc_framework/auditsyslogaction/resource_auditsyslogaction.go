...
var _ resource.ResourceWithUpgradeState = &AuditsyslogactionResource{}
...
func (r *AuditsyslogactionResource) UpgradeState(ctx context.Context) map[int64]resource.StateUpgrader {
	...
	return utils.WoVersionUpgradeState(schemaResp.Schema, func(ctx context.Context, req resource.UpgradeStateRequest, resp *resource.UpgradeStateResponse) {
		...
		if data.HttpauthtokenWoVersion.IsNull() {
			data.HttpauthtokenWoVersion = types.Int64Value(1)
		}
