...
func aaagroup_vpntrafficpolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *AaagroupVpntrafficpolicyBindingResourceModel) aaa.Aaagroupvpntrafficpolicybinding {
	tflog.Debug(ctx, "In aaagroup_vpntrafficpolicy_bindingGetThePayloadFromtheConfig Function")
