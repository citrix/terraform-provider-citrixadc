...
// AaagroupVpntrafficpolicyBindingDataSourceModel is the data-source-specific
...
// Computed.
type AaagroupVpntrafficpolicyBindingDataSourceModel struct {
	...
	// (zion73x_readonly/aaagroup_vpntrafficpolicy_binding.json).
	Acttype types.Int64 `tfsdk:"acttype"`
}

func AaagroupVpntrafficpolicyBindingDataSourceSchema() schema.Schema {
...
// aaagroup_vpntrafficpolicy_bindingDataSourceSetAttrFromGet projects a NITRO GET
...
func aaagroup_vpntrafficpolicy_bindingDataSourceSetAttrFromGet(ctx context.Context, data *AaagroupVpntrafficpolicyBindingDataSourceModel, g map[string]interface{}) {
	tflog.Debug(ctx, "In aaagroup_vpntrafficpolicy_bindingDataSourceSetAttrFromGet Function")
