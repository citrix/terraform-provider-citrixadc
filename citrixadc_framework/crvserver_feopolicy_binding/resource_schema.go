...
func crvserver_feopolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *CrvserverFeopolicyBindingResourceModel) cr.Crvserverfeopolicybinding {
	tflog.Debug(ctx, "In crvserver_feopolicy_bindingGetThePayloadFromtheConfig Function")
