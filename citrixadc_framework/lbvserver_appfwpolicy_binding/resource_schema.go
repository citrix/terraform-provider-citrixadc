...
func (r *LbvserverAppfwpolicyBindingResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func lbvserver_appfwpolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *LbvserverAppfwpolicyBindingResourceModel) lb.Lbvserverappfwpolicybinding {
	tflog.Debug(ctx, "In lbvserver_appfwpolicy_bindingGetThePayloadFromtheConfig Function")
	...
	if !data.Invoke.IsNull() {
		lbvserver_appfwpolicy_binding.Invoke = data.Invoke.ValueBool()
	}
	if !data.Labelname.IsNull() {
		lbvserver_appfwpolicy_binding.Labelname = data.Labelname.ValueString()
	}
	if !data.Labeltype.IsNull() {
		lbvserver_appfwpolicy_binding.Labeltype = data.Labeltype.ValueString()
	}
	if !data.Name.IsNull() {
		lbvserver_appfwpolicy_binding.Name = data.Name.ValueString()
	}
	if !data.Order.IsNull() {
		lbvserver_appfwpolicy_binding.Order = utils.IntPtr(int(data.Order.ValueInt64()))
	}
	if !data.Policyname.IsNull() {
		lbvserver_appfwpolicy_binding.Policyname = data.Policyname.ValueString()
	}
	if !data.Priority.IsNull() {
		lbvserver_appfwpolicy_binding.Priority = utils.IntPtr(int(data.Priority.ValueInt64()))
	}
