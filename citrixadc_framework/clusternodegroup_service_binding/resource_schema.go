...
// ClusternodegroupServiceBindingResourceModel describes the resource data model.
type ClusternodegroupServiceBindingResourceModel struct {
	Id      types.String `tfsdk:"id"`
	Name    types.String `tfsdk:"name"`
	Service types.String `tfsdk:"service"`
}

func (r *ClusternodegroupServiceBindingResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
