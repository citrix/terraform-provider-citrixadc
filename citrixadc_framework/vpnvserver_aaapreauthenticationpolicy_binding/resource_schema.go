...
func vpnvserver_aaapreauthenticationpolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *VpnvserverAaapreauthenticationpolicyBindingResourceModel) vpn.Vpnvserveraaapreauthenticationpolicybinding {
	tflog.Debug(ctx, "In vpnvserver_aaapreauthenticationpolicy_bindingGetThePayloadFromtheConfig Function")
