...
func crvserver_responderpolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *CrvserverResponderpolicyBindingResourceModel) cr.Crvserverresponderpolicybinding {
	tflog.Debug(ctx, "In crvserver_responderpolicy_bindingGetThePayloadFromtheConfig Function")
