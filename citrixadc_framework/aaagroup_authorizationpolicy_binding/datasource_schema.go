...
// AaagroupAuthorizationpolicyBindingDataSourceModel is the data-source-specific
...
type AaagroupAuthorizationpolicyBindingDataSourceModel struct {
	...
	// (zion73x_readonly/aaagroup_authorizationpolicy_binding.json).
	Acttype types.Int64 `tfsdk:"acttype"`
}

func AaagroupAuthorizationpolicyBindingDataSourceSchema() schema.Schema {
...
// aaagroup_authorizationpolicy_bindingDataSourceSetAttrFromGet projects a NITRO
...
func aaagroup_authorizationpolicy_bindingDataSourceSetAttrFromGet(ctx context.Context, data *AaagroupAuthorizationpolicyBindingDataSourceModel, g map[string]interface{}) {
	tflog.Debug(ctx, "In aaagroup_authorizationpolicy_bindingDataSourceSetAttrFromGet Function")
