...
func (r *AuthenticationvserverVpnportalthemeBindingResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if data.Id.IsNull() {
		resp.Diagnostics.AddError("Client Error", "authenticationvserver_vpnportaltheme_binding not found on the ADC immediately after create")
		return
	}
...
func (r *AuthenticationvserverVpnportalthemeBindingResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if data.Id.IsNull() {
		resp.Diagnostics.AddError("Client Error", "authenticationvserver_vpnportaltheme_binding not found on the ADC immediately after update")
		return
	}
