...
func vpnvserver_authenticationoauthidppolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *VpnvserverAuthenticationoauthidppolicyBindingResourceModel) vpn.Vpnvserverauthenticationoauthidppolicybinding {
	tflog.Debug(ctx, "In vpnvserver_authenticationoauthidppolicy_bindingGetThePayloadFromtheConfig Function")
