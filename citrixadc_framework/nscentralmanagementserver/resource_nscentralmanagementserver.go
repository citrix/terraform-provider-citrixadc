...
var _ resource.ResourceWithUpgradeState = &NscentralmanagementserverResource{}
...
func (r *NscentralmanagementserverResource) UpgradeState(ctx context.Context) map[int64]resource.StateUpgrader {
	...
	return utils.WoVersionUpgradeState(schemaResp.Schema, func(ctx context.Context, req resource.UpgradeStateRequest, resp *resource.UpgradeStateResponse) {
		...
		if data.AdcpasswordWoVersion.IsNull() {
			data.AdcpasswordWoVersion = types.Int64Value(1)
		}
