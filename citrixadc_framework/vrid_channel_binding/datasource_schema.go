...
// vrid_channel_bindingDataSourceSetAttrFromGet faithfully copies every field from
...
func vrid_channel_bindingDataSourceSetAttrFromGet(ctx context.Context, data *VridChannelBindingDataSourceModel, g map[string]interface{}) {
	tflog.Debug(ctx, "In vrid_channel_bindingDataSourceSetAttrFromGet Function")
