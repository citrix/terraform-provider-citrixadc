...
// AuthenticationvserverAuthenticationpolicyBindingDataSourceModel is the
...
type AuthenticationvserverAuthenticationpolicyBindingDataSourceModel struct {
	...
	// (zion73x_readonly/authenticationvserver_authenticationpolicy_binding.json).
	// Never settable; populated from GET, null when the appliance omits them.
	Acttype types.Int64 `tfsdk:"acttype"`
}

func AuthenticationvserverAuthenticationpolicyBindingDataSourceSchema() schema.Schema {
...
// authenticationvserver_authenticationpolicy_bindingDataSourceSetAttrFromGet
...
func authenticationvserver_authenticationpolicy_bindingDataSourceSetAttrFromGet(ctx context.Context, data *AuthenticationvserverAuthenticationpolicyBindingDataSourceModel, g map[string]interface{}) {
	tflog.Debug(ctx, "In authenticationvserver_authenticationpolicy_bindingDataSourceSetAttrFromGet Function")
