...
var _ resource.ResourceWithUpgradeState = &SslcertreqResource{}
...
func (r *SslcertreqResource) UpgradeState(ctx context.Context) map[int64]resource.StateUpgrader {
	...
	return utils.WoVersionUpgradeState(schemaResp.Schema, func(ctx context.Context, req resource.UpgradeStateRequest, resp *resource.UpgradeStateResponse) {
		...
		if data.ChallengepasswordWoVersion.IsNull() {
			data.ChallengepasswordWoVersion = types.Int64Value(1)
		}
