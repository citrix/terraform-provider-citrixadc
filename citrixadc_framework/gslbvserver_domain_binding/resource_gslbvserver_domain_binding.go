...
func (r *GslbvserverDomainBindingResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if data.Id.IsNull() {
		resp.Diagnostics.AddError("Client Error", "gslbvserver_domain_binding not found on the ADC immediately after create")
		return
	}
...
func (r *GslbvserverDomainBindingResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if data.Id.IsNull() {
		resp.Diagnostics.AddError("Client Error", "gslbvserver_domain_binding not found on the ADC immediately after update")
		return
	}
