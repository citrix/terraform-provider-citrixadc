...
func globalbindingChanged(o, n ResponderpolicyGlobalbindingModel) bool {
...
func (r *ResponderpolicyResource) syncGlobalbindings(ctx context.Context, policyname string, oldSet, newSet types.Set) error {
	...
	newByKey := map[string]ResponderpolicyGlobalbindingModel{}
	for _, b := range newB {
		newByKey[globalKey(b)] = b
	}
	oldByKey := map[string]ResponderpolicyGlobalbindingModel{}
	for _, b := range oldB {
...
func lbvserverbindingChanged(o, n ResponderpolicyLbvserverbindingModel) bool {
	return attrChanged(o.Gotopriorityexpression, n.Gotopriorityexpression) ||
		attrChanged(o.Invoke, n.Invoke) ||
		attrChanged(o.Labelname, n.Labelname) ||
		attrChanged(o.Labeltype, n.Labeltype)
...
func (r *ResponderpolicyResource) syncLbvserverbindings(ctx context.Context, policyname string, oldSet, newSet types.Set) error {
	...
	newByKey := map[string]ResponderpolicyLbvserverbindingModel{}
	for _, b := range newB {
		newByKey[lbvserverKey(b)] = b
	}
	oldByKey := map[string]ResponderpolicyLbvserverbindingModel{}
	for _, b := range oldB {
...
// trigger a rebind.
func csvserverbindingChanged(o, n ResponderpolicyCsvserverbindingModel) bool {
	return attrChanged(o.Gotopriorityexpression, n.Gotopriorityexpression) ||
		attrChanged(o.Invoke, n.Invoke) ||
		attrChanged(o.Labelname, n.Labelname) ||
		attrChanged(o.Labeltype, n.Labeltype) ||
...
func (r *ResponderpolicyResource) syncCsvserverbindings(ctx context.Context, policyname string, oldSet, newSet types.Set) error {
	...
	newByKey := map[string]ResponderpolicyCsvserverbindingModel{}
	for _, b := range newB {
		newByKey[csvserverKey(b)] = b
	}
	oldByKey := map[string]ResponderpolicyCsvserverbindingModel{}
	for _, b := range oldB {
