...
func vpnglobal_vpnurlpolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *VpnglobalVpnurlpolicyBindingResourceModel) vpn.Vpnglobalvpnurlpolicybinding {
	tflog.Debug(ctx, "In vpnglobal_vpnurlpolicy_bindingGetThePayloadFromtheConfig Function")
