...
// VpnvserverAuditsyslogpolicyBindingDataSourceModel is the data-source-specific
// model, decoupled from the resource model. It exposes the read/write attributes
// (as Computed outputs) AND the read-only attributes the appliance returns on a
// GET (zion73x_readonly/vpnvserver_auditsyslogpolicy_binding.json) that the
// resource intentionally omits.
type VpnvserverAuditsyslogpolicyBindingDataSourceModel struct {
...
func VpnvserverAuditsyslogpolicyBindingDataSourceSchema() schema.Schema {
...
// vpnvserver_auditsyslogpolicy_bindingDataSourceSetAttrFromGet projects a NITRO GET
...
func vpnvserver_auditsyslogpolicy_bindingDataSourceSetAttrFromGet(ctx context.Context, data *VpnvserverAuditsyslogpolicyBindingDataSourceModel, g map[string]interface{}) {
	tflog.Debug(ctx, "In vpnvserver_auditsyslogpolicy_bindingDataSourceSetAttrFromGet Function")
