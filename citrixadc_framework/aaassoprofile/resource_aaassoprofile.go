...
var _ resource.ResourceWithUpgradeState = &AaassoprofileResource{}
...
func (r *AaassoprofileResource) UpgradeState(ctx context.Context) map[int64]resource.StateUpgrader {
