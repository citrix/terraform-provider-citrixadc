...
func crvserver_icapolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *CrvserverIcapolicyBindingResourceModel) cr.Crvservericapolicybinding {
	tflog.Debug(ctx, "In crvserver_icapolicy_bindingGetThePayloadFromtheConfig Function")
