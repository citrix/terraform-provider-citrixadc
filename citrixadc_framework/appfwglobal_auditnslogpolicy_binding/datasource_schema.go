...
// AppfwglobalAuditnslogpolicyBindingDataSourceModel is the data-source-specific
// model, decoupled from AppfwglobalAuditnslogpolicyBindingResourceModel.
//
...
// declares.
type AppfwglobalAuditnslogpolicyBindingDataSourceModel struct {
	...
	// (zion73x_readonly/appfwglobal_auditnslogpolicy_binding.json). Never
	// settable; populated from GET.
	Policytype types.String `tfsdk:"policytype"`
}

func AppfwglobalAuditnslogpolicyBindingDataSourceSchema() schema.Schema {
...
// appfwglobal_auditnslogpolicy_bindingDataSourceSetAttrFromGet projects a NITRO
// appfwglobal_auditnslogpolicy_binding GET response onto the data-source model. A
...
func appfwglobal_auditnslogpolicy_bindingDataSourceSetAttrFromGet(ctx context.Context, data *AppfwglobalAuditnslogpolicyBindingDataSourceModel, g map[string]interface{}) {
	tflog.Debug(ctx, "In appfwglobal_auditnslogpolicy_bindingDataSourceSetAttrFromGet Function")
