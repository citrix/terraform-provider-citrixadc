...
func (r *LbvserverLbpolicyBindingResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func lbvserver_lbpolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *LbvserverLbpolicyBindingResourceModel) lb.Lbvserverlbpolicybinding {
	...
	return lbvserver_lbpolicy_binding
}

func lbvserver_lbpolicy_bindingSetAttrFromGet(ctx context.Context, data *LbvserverLbpolicyBindingResourceModel, getResponseData map[string]interface{}) *LbvserverLbpolicyBindingResourceModel {
