...
func vpnglobal_authenticationlocalpolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *VpnglobalAuthenticationlocalpolicyBindingResourceModel) vpn.Vpnglobalauthenticationlocalpolicybinding {
	tflog.Debug(ctx, "In vpnglobal_authenticationlocalpolicy_bindingGetThePayloadFromtheConfig Function")
