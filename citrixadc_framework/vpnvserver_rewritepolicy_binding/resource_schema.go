...
// VpnvserverRewritepolicyBindingResourceModel describes the resource data model.
type VpnvserverRewritepolicyBindingResourceModel struct {
...
func (r *VpnvserverRewritepolicyBindingResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func vpnvserver_rewritepolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *VpnvserverRewritepolicyBindingResourceModel) vpn.Vpnvserverrewritepolicybinding {
	...
	return vpnvserver_rewritepolicy_binding
}

func vpnvserver_rewritepolicy_bindingSetAttrFromGet(ctx context.Context, data *VpnvserverRewritepolicyBindingResourceModel, getResponseData map[string]interface{}) *VpnvserverRewritepolicyBindingResourceModel {
	tflog.Debug(ctx, "In vpnvserver_rewritepolicy_bindingSetAttrFromGet Function")
