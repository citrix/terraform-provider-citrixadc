...
func vpnvserver_feopolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *VpnvserverFeopolicyBindingResourceModel) vpn.Vpnvserverfeopolicybinding {
	tflog.Debug(ctx, "In vpnvserver_feopolicy_bindingGetThePayloadFromtheConfig Function")
