...
// AaauserAuditsyslogpolicyBindingDataSourceModel is the data-source-specific
// model, decoupled from AaauserAuditsyslogpolicyBindingResourceModel.
//
...
type AaauserAuditsyslogpolicyBindingDataSourceModel struct {
	...
	// (zion73x_readonly/aaauser_auditsyslogpolicy_binding.json). Never settable;
	// populated from GET, null when the appliance omits them.
	Acttype types.Int64 `tfsdk:"acttype"`
}

func AaauserAuditsyslogpolicyBindingDataSourceSchema() schema.Schema {
...
// aaauser_auditsyslogpolicy_bindingDataSourceSetAttrFromGet projects a NITRO
// aaauser_auditsyslogpolicy_binding GET response onto the data-source model.
// Attributes are simply filled from the GET (or left Null when the GET omits
// them) via the shared utils.MapGet* helpers.
func aaauser_auditsyslogpolicy_bindingDataSourceSetAttrFromGet(ctx context.Context, data *AaauserAuditsyslogpolicyBindingDataSourceModel, g map[string]interface{}) {
	tflog.Debug(ctx, "In aaauser_auditsyslogpolicy_bindingDataSourceSetAttrFromGet Function")
