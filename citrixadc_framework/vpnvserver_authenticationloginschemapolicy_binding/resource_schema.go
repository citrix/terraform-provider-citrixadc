...
func vpnvserver_authenticationloginschemapolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *VpnvserverAuthenticationloginschemapolicyBindingResourceModel) vpn.Vpnvserverauthenticationloginschemapolicybinding {
	tflog.Debug(ctx, "In vpnvserver_authenticationloginschemapolicy_bindingGetThePayloadFromtheConfig Function")
