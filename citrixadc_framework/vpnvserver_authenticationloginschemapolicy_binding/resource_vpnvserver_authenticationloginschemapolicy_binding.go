...
func (r *VpnvserverAuthenticationloginschemapolicyBindingResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if data.Id.IsNull() {
		resp.Diagnostics.AddError("Client Error", "vpnvserver_authenticationloginschemapolicy_binding not found on the ADC immediately after create")
		return
	}
...
func (r *VpnvserverAuthenticationloginschemapolicyBindingResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if data.Id.IsNull() {
		resp.Diagnostics.AddError("Client Error", "vpnvserver_authenticationloginschemapolicy_binding not found on the ADC immediately after update")
		return
	}
