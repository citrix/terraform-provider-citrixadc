...
// AuditsyslogglobalAuditsyslogpolicyBindingDataSourceModel is the
// data-source-specific model, decoupled from
// AuditsyslogglobalAuditsyslogpolicyBindingResourceModel.
//
...
type AuditsyslogglobalAuditsyslogpolicyBindingDataSourceModel struct {
	...
	// (zion73x_readonly/auditsyslogglobal_auditsyslogpolicy_binding.json). Never
...
// auditsyslogglobal_auditsyslogpolicy_bindingDataSourceSetAttrFromGet projects a
// NITRO auditsyslogglobal_auditsyslogpolicy_binding GET response onto the
...
func auditsyslogglobal_auditsyslogpolicy_bindingDataSourceSetAttrFromGet(ctx context.Context, data *AuditsyslogglobalAuditsyslogpolicyBindingDataSourceModel, g map[string]interface{}) {
	tflog.Debug(ctx, "In auditsyslogglobal_auditsyslogpolicy_bindingDataSourceSetAttrFromGet Function")
