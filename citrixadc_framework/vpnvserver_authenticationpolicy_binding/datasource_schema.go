...
// VpnvserverAuthenticationpolicyBindingDataSourceModel is the
...
type VpnvserverAuthenticationpolicyBindingDataSourceModel struct {
	...
	// (zion73x_readonly/vpnvserver_authenticationpolicy_binding.json).
	Acttype types.Int64 `tfsdk:"acttype"`
}

func VpnvserverAuthenticationpolicyBindingDataSourceSchema() schema.Schema {
...
// vpnvserver_authenticationpolicy_bindingDataSourceSetAttrFromGet projects a
...
func vpnvserver_authenticationpolicy_bindingDataSourceSetAttrFromGet(ctx context.Context, data *VpnvserverAuthenticationpolicyBindingDataSourceModel, g map[string]interface{}) {
	tflog.Debug(ctx, "In vpnvserver_authenticationpolicy_bindingDataSourceSetAttrFromGet Function")
	...
	// Composite key id (legacy format: bindpoint:<bindpoint>,name:<name>,policy:<policy>).
	idParts := []string{}
	idParts = append(idParts, fmt.Sprintf("bindpoint:%s", utils.UrlEncode(data.Bindpoint.ValueString())))
