...
func vpnvserver_authenticationwebauthpolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *VpnvserverAuthenticationwebauthpolicyBindingResourceModel) vpn.Vpnvserverauthenticationwebauthpolicybinding {
	tflog.Debug(ctx, "In vpnvserver_authenticationwebauthpolicy_bindingGetThePayloadFromtheConfig Function")
