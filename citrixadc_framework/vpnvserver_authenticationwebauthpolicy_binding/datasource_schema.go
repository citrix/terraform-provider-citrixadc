...
// VpnvserverAuthenticationwebauthpolicyBindingDataSourceModel is the
...
type VpnvserverAuthenticationwebauthpolicyBindingDataSourceModel struct {
	...
	// (zion73x_readonly/vpnvserver_authenticationwebauthpolicy_binding.json).
	// Never settable; populated from GET.
	Acttype types.Int64 `tfsdk:"acttype"`
}

func VpnvserverAuthenticationwebauthpolicyBindingDataSourceSchema() schema.Schema {
...
// vpnvserver_authenticationwebauthpolicy_bindingDataSourceSetAttrFromGet projects
...
// that projection.
func vpnvserver_authenticationwebauthpolicy_bindingDataSourceSetAttrFromGet(ctx context.Context, data *VpnvserverAuthenticationwebauthpolicyBindingDataSourceModel, g map[string]interface{}) {
	tflog.Debug(ctx, "In vpnvserver_authenticationwebauthpolicy_bindingDataSourceSetAttrFromGet Function")
