...
var _ resource.ResourceWithUpgradeState = &AuthenticationtacacsactionResource{}
...
func (r *AuthenticationtacacsactionResource) UpgradeState(ctx context.Context) map[int64]resource.StateUpgrader {
	...
	return utils.WoVersionUpgradeState(schemaResp.Schema, func(ctx context.Context, req resource.UpgradeStateRequest, resp *resource.UpgradeStateResponse) {
		...
		if data.TacacssecretWoVersion.IsNull() {
			data.TacacssecretWoVersion = types.Int64Value(1)
		}
