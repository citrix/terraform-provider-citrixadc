...
const testAccSslserviceSslciphersuiteBindingDataSource_basic = `
resource "citrixadc_sslservice" "demo_sslservice" {
	cipherredirect = "DISABLED"
	clientauth = "DISABLED"
	dh = "DISABLED"
...
data "citrixadc_sslservice_sslciphersuite_binding" "tf_sslservice_sslciphersuite_binding" {
	servicename = citrixadc_sslservice_sslciphersuite_binding.tf_sslservice_sslciphersuite_binding.servicename
	ciphername = citrixadc_sslservice_sslciphersuite_binding.tf_sslservice_sslciphersuite_binding.ciphername
	depends_on = [citrixadc_sslservice_sslciphersuite_binding.tf_sslservice_sslciphersuite_binding]
}
`
...
func TestAccSslservice_sslciphersuite_bindingDataSource_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccSslserviceSslciphersuiteBindingDataSource_basic,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("data.citrixadc_sslservice_sslciphersuite_binding.tf_sslservice_sslciphersuite_binding", "servicename", "tf_service"),
					resource.TestCheckResourceAttr("data.citrixadc_sslservice_sslciphersuite_binding.tf_sslservice_sslciphersuite_binding", "ciphername", "tfAccsslcipher"),
				),
			},
		},
	})
...
func TestAccSslservice_sslciphersuite_binding_import(t *testing.T) {
	...
	// order: servicename,ciphername) so it matches exactly what SDK v2 wrote.
	legacyID := func(s *terraform.State) (string, error) {
		...
		ordr := []string{"servicename", "ciphername"}
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{Config: testAccSslservice_sslciphersuite_binding_basic_step1, ResourceName: resAddr, ImportState: true, ImportStateIdFunc: legacyID, ImportStateVerify: true, ImportStateVerifyIgnore: []string{}},
		},
	})
}
