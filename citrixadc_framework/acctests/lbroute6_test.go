...
data "citrixadc_lbroute6" "demo_route6" {
    network = citrixadc_lbroute6.demo_route6.network
    td = 0
    depends_on = [citrixadc_lbroute6.demo_route6]
}
`
...
func TestAccLbroute6DataSource_basic(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccLbroute6DataSource_basic,
				Check: resource.ComposeTestCheckFunc(
