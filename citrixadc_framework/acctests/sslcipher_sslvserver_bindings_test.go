...
// NOTE: sslvserver_sslciphersuite_binding is rejected with ec3740 "Operation not
// permitted. Use profile command" when the appliance has SSL default profiles
// ENABLED. Run this against a box with sslparameter.defaultprofile=DISABLED
// (the STANDALONE_NON_DEFAULT_SSL_PROFILE bed, e.g. .155).
