...
//
// The citrixadc_rdpconnections datasource is UNCHANGED by the kill-action
// refactor; this sub-test is preserved verbatim from the original
// rdpconnections_test.go and still targets the data source type
// citrixadc_rdpconnections.
//
