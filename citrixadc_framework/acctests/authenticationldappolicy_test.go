...
func testAccCheckAuthenticationldappolicyExist(n string, id *string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		data, err := client.FindResource(service.Authenticationldappolicy.Type(), rs.Primary.ID)
...
func testAccCheckAuthenticationldappolicyDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		...
		_, err := client.FindResource(service.Authenticationldappolicy.Type(), rs.Primary.ID)
		if err == nil {
