		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAaauser_authorizationpolicy_bindingExist("citrixadc_aaauser_authorizationpolicy_binding.tf_aaauser_authorizationpolicy_binding", nil),
				),
			},
			{
				Config: testAccAaauser_authorizationpolicy_binding_basic_step2,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAaauser_authorizationpolicy_bindingNotExist("citrixadc_aaauser_authorizationpolicy_binding.tf_aaauser_authorizationpolicy_binding", "user1,tp-authorize-1"),
				),
			},
		},
	})
...
func TestAccAaauser_authorizationpolicy_binding_import(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{Config: testAccAaauser_authorizationpolicy_binding_basic},
			{Config: testAccAaauser_authorizationpolicy_binding_basic, ResourceName: resAddr, ImportState: true, ImportStateVerify: true, ImportStateVerifyIgnore: []string{}},
			{Config: testAccAaauser_authorizationpolicy_binding_basic, ResourceName: resAddr, ImportState: true, ImportStateIdFunc: legacyID, ImportStateVerify: true, ImportStateVerifyIgnore: []string{}},
		},
	})
}

func testAccCheckAaauser_authorizationpolicy_bindingExist(n string, id *string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		if rs.Primary.ID == "" {
			return fmt.Errorf("No aaauser_authorizationpolicy_binding id is set")
		}
		...
		findParams := service.FindParams{
			ResourceType:             "aaauser_authorizationpolicy_binding",
		...
		if !found {
			return fmt.Errorf("aaauser_authorizationpolicy_binding %s not found", n)
		}
...
func testAccCheckAaauser_authorizationpolicy_bindingNotExist(n string, id string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		// Use the shared utility function to get a configured client
		client, err := testAccGetFrameworkClient()
		if err != nil {
		...
		if found {
			return fmt.Errorf("aaauser_authorizationpolicy_binding %s was found, but it should have been destroyed", n)
		}
...
func testAccCheckAaauser_authorizationpolicy_bindingDestroy(s *terraform.State) error {
	// Use the shared utility function to get a configured client
	client, err := testAccGetFrameworkClient()
	if err != nil {
		return fmt.Errorf("Failed to get test client: %v", err)
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "citrixadc_aaauser_authorizationpolicy_binding" {
			continue
		}
		...
		_, err := client.FindResource(service.Aaauser_authorizationpolicy_binding.Type(), rs.Primary.ID)
		if err == nil {
			return fmt.Errorf("aaauser_authorizationpolicy_binding %s still exists", rs.Primary.ID)
		}
...
const testAccAaauser_authorizationpolicy_binding_upgrade_basic = `
	resource "citrixadc_aaauser" "tf_aaauser" {
		username = "user1"
		password = "my_pass"
	}
...
func TestAccAaauser_authorizationpolicy_binding_sdkv2StateUpgrade(t *testing.T) {
	resource.Test(t, resource.TestCase{
		PreCheck:     func() { testAccPreCheck(t) },
		CheckDestroy: testAccCheckAaauser_authorizationpolicy_bindingDestroy,
		Steps: []resource.TestStep{
			{
				...
				Config: testAccAaauser_authorizationpolicy_binding_upgrade_basic,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAaauser_authorizationpolicy_bindingExist("citrixadc_aaauser_authorizationpolicy_binding.tf_aaauser_authorizationpolicy_binding", nil),
					resource.TestCheckResourceAttr("citrixadc_aaauser_authorizationpolicy_binding.tf_aaauser_authorizationpolicy_binding", "id", "user1,tp-authorize-1"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAaauser_authorizationpolicy_bindingExist("citrixadc_aaauser_authorizationpolicy_binding.tf_aaauser_authorizationpolicy_binding", nil),
					resource.TestCheckResourceAttr("citrixadc_aaauser_authorizationpolicy_binding.tf_aaauser_authorizationpolicy_binding", "id", "policy:tp-authorize-1,username:user1"),
				),
			},
		},
	})
