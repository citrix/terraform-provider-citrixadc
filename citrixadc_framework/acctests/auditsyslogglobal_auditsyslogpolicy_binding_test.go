...
const testAccAuditsyslogglobalAuditsyslogpolicyBindingDataSource_basic = `
	...
	data "citrixadc_auditsyslogglobal_auditsyslogpolicy_binding" "tf_auditsyslogglobal_auditsyslogpolicy_binding" {
		policyname     = citrixadc_auditsyslogglobal_auditsyslogpolicy_binding.tf_auditsyslogglobal_auditsyslogpolicy_binding.policyname
		globalbindtype = citrixadc_auditsyslogglobal_auditsyslogpolicy_binding.tf_auditsyslogglobal_auditsyslogpolicy_binding.globalbindtype
		depends_on     = [citrixadc_auditsyslogglobal_auditsyslogpolicy_binding.tf_auditsyslogglobal_auditsyslogpolicy_binding]
	}
`

func TestAccAuditsyslogglobalAuditsyslogpolicyBindingDataSource_basic(t *testing.T) {
	resource.Test(t, resource.TestCase{
		PreCheck:                 func() { testAccPreCheck(t) },
		ProtoV6ProviderFactories: testAccProtoV6ProviderFactories,
		Steps: []resource.TestStep{
			{
				Config: testAccAuditsyslogglobalAuditsyslogpolicyBindingDataSource_basic,
				Check: resource.ComposeTestCheckFunc(
