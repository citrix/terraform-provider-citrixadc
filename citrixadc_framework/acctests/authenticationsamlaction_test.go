		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAuthenticationsamlactionExist("citrixadc_authenticationsamlaction.tf_samlaction", nil),
			...
			{
				Config: testAccAuthenticationsamlaction_update,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAuthenticationsamlactionExist("citrixadc_authenticationsamlaction.tf_samlaction", nil),
					resource.TestCheckResourceAttr("citrixadc_authenticationsamlaction.tf_samlaction", "name", "tf_samlaction"),
...
func TestAccAuthenticationsamlaction_sdkv2StateUpgrade(t *testing.T) {
	resource.Test(t, resource.TestCase{
		PreCheck:     func() { testAccPreCheck(t) },
		CheckDestroy: testAccCheckAuthenticationsamlactionDestroy,
		Steps: []resource.TestStep{
...
func testAccCheckAuthenticationsamlactionExist(n string, id *string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		if rs.Primary.ID == "" {
			return fmt.Errorf("No authenticationsamlaction name is set")
		}
		...
		if data == nil {
			return fmt.Errorf("authenticationsamlaction %s not found", n)
		}
