...
func TestAccVpnvserver_vpnintranetapplication_binding_import(t *testing.T) {
	const resAddr = "citrixadc_vpnvserver_vpnintranetapplication_binding.tf_bind"

	// Backward-compat: import via the LEGACY SDK v2 id. Rebuild the legacy positional id from
	// the current canonical key:value id (raw values, only the keys actually set, in legacy
	// order: name,intranetapplication) so it matches exactly what SDK v2 wrote.
	legacyID := func(s *terraform.State) (string, error) {
		...
		ordr := []string{"name", "intranetapplication"}
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{Config: testAccVpnvserver_vpnintranetapplication_binding_basic},
			{Config: testAccVpnvserver_vpnintranetapplication_binding_basic, ResourceName: resAddr, ImportState: true, ImportStateVerify: true, ImportStateVerifyIgnore: []string{}},
			{Config: testAccVpnvserver_vpnintranetapplication_binding_basic, ResourceName: resAddr, ImportState: true, ImportStateIdFunc: legacyID, ImportStateVerify: true, ImportStateVerifyIgnore: []string{}},
		},
	})
}
...
func testAccCheckVpnvserver_vpnintranetapplication_bindingExist(n string, id *string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		idMap, _, err := utils.ParseIdString(bindingId, []string{"name", "intranetapplication"}, nil)
		if err != nil {
...
func testAccCheckVpnvserver_vpnintranetapplication_bindingNotExist(n string, id string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		idMap, _, err := utils.ParseIdString(id, []string{"name", "intranetapplication"}, nil)
		if err != nil {
...
func testAccCheckVpnvserver_vpnintranetapplication_bindingDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		...
		_, err := client.FindResource(service.Vpnvserver_vpnintranetapplication_binding.Type(), rs.Primary.ID)
		if err == nil {
...
const testAccVpnvserver_vpnintranetapplication_binding_upgrade_basic = `
	resource "citrixadc_vpnvserver" "tf_vpnvserver" {
		name           = "tf_examplevserver"
		servicetype    = "SSL"
		ipv46          = "3.3.3.3"
...
func TestAccVpnvserver_vpnintranetapplication_binding_sdkv2StateUpgrade(t *testing.T) {
	resource.Test(t, resource.TestCase{
		PreCheck:     func() { testAccPreCheck(t) },
		CheckDestroy: testAccCheckVpnvserver_vpnintranetapplication_bindingDestroy,
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckVpnvserver_vpnintranetapplication_bindingExist("citrixadc_vpnvserver_vpnintranetapplication_binding.tf_bind", nil),
					resource.TestCheckResourceAttr("citrixadc_vpnvserver_vpnintranetapplication_binding.tf_bind", "id", "tf_examplevserver,tf_vpnintranetapplication"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckVpnvserver_vpnintranetapplication_bindingExist("citrixadc_vpnvserver_vpnintranetapplication_binding.tf_bind", nil),
					resource.TestCheckResourceAttr("citrixadc_vpnvserver_vpnintranetapplication_binding.tf_bind", "id", "intranetapplication:tf_vpnintranetapplication,name:tf_examplevserver"),
				),
			},
		},
	})
...
func TestAccVpnvserver_vpnintranetapplication_binding_selfHealing(t *testing.T) {
	const resAddr = "citrixadc_vpnvserver_vpnintranetapplication_binding.tf_bind"
	resource.Test(t, resource.TestCase{
		PreCheck:                 func() { testAccPreCheck(t) },
		ProtoV6ProviderFactories: testAccProtoV6ProviderFactories,
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVpnvserver_vpnintranetapplication_binding_basic,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckVpnvserver_vpnintranetapplication_bindingExist(resAddr, nil),
				),
			},
			{
				PreConfig: func() {
					...
					if err := client.DeleteResourceWithArgsMap(service.Vpnvserver_vpnintranetapplication_binding.Type(), "tf_examplevserver", map[string]string{"intranetapplication": "tf_vpnintranetapplication"}); err != nil {
