...
const testAccAuthenticationvserver_authenticationsamlpolicy_binding_basic = `
...
const testAccAuthenticationvserver_authenticationsamlpolicy_binding_basic_step2 = `
...
func TestAccAuthenticationvserver_authenticationsamlpolicy_binding_basic(t *testing.T) {
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAuthenticationvserver_authenticationsamlpolicy_bindingExist("citrixadc_authenticationvserver_authenticationsamlpolicy_binding.tf_bind", nil),
				),
			},
			{
				Config: testAccAuthenticationvserver_authenticationsamlpolicy_binding_basic_step2,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAuthenticationvserver_authenticationsamlpolicy_bindingNotExist("citrixadc_authenticationvserver_authenticationsamlpolicy_binding.tf_bind", "tf_authenticationvserver,tf_samlpolicy"),
				),
			},
		},
	})
...
func TestAccAuthenticationvserver_authenticationsamlpolicy_binding_import(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{Config: testAccAuthenticationvserver_authenticationsamlpolicy_binding_basic, ResourceName: resAddr, ImportState: true, ImportStateIdFunc: legacyID, ImportStateVerify: true, ImportStateVerifyIgnore: []string{"bindpoint"}},
		},
	})
}
...
func testAccCheckAuthenticationvserver_authenticationsamlpolicy_bindingExist(n string, id *string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		if rs.Primary.ID == "" {
			return fmt.Errorf("No authenticationvserver_authenticationsamlpolicy_binding id is set")
		}
		...
		findParams := service.FindParams{
			ResourceType:             "authenticationvserver_authenticationsamlpolicy_binding",
			ResourceName:             name,
		...
		if !found {
			return fmt.Errorf("authenticationvserver_authenticationsamlpolicy_binding %s not found", n)
		}
...
func testAccCheckAuthenticationvserver_authenticationsamlpolicy_bindingNotExist(n string, id string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		// Use the shared utility function to get a configured client
		client, err := testAccGetFrameworkClient()
		if err != nil {
		...
		if found {
			return fmt.Errorf("authenticationvserver_authenticationsamlpolicy_binding %s was found, but it should have been destroyed", n)
		}
...
func testAccCheckAuthenticationvserver_authenticationsamlpolicy_bindingDestroy(s *terraform.State) error {
	// Use the shared utility function to get a configured client
	client, err := testAccGetFrameworkClient()
	if err != nil {
		return fmt.Errorf("Failed to get test client: %v", err)
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "citrixadc_authenticationvserver_authenticationsamlpolicy_binding" {
			continue
		}
		...
		_, err := client.FindResource(service.Authenticationvserver_authenticationsamlpolicy_binding.Type(), rs.Primary.ID)
		if err == nil {
			return fmt.Errorf("authenticationvserver_authenticationsamlpolicy_binding %s still exists", rs.Primary.ID)
		}
...
func TestAccAuthenticationvserver_authenticationsamlpolicy_binding_selfHealing(t *testing.T) {
	const resAddr = "citrixadc_authenticationvserver_authenticationsamlpolicy_binding.tf_bind"
	resource.Test(t, resource.TestCase{
		PreCheck:                 func() { testAccPreCheck(t) },
		ProtoV6ProviderFactories: testAccProtoV6ProviderFactories,
		...
		Steps: []resource.TestStep{
			{
				Config: testAccAuthenticationvserver_authenticationsamlpolicy_binding_basic,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAuthenticationvserver_authenticationsamlpolicy_bindingExist(resAddr, nil),
				),
			},
			{
				PreConfig: func() {
					...
					if err := client.DeleteResourceWithArgsMap(service.Authenticationvserver_authenticationsamlpolicy_binding.Type(), "tf_authenticationvserver", map[string]string{"policy": "tf_samlpolicy", "bindpoint": "RESPONSE"}); err != nil {
