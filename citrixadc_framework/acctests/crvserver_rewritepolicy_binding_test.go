...
func TestAccCrvserver_rewritepolicy_binding_basic(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccCrvserver_rewritepolicy_binding_basic_step2,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCrvserver_rewritepolicy_bindingNotExist("citrixadc_crvserver_rewritepolicy_binding.crvserver_rewritepolicy_binding", "my_vserver,tf_rewrite_policy"),
				),
			},
		},
	})
...
func testAccCheckCrvserver_rewritepolicy_bindingExist(n string, id *string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		if rs.Primary.ID == "" {
			return fmt.Errorf("No crvserver_rewritepolicy_binding id is set")
		}
		...
		if !found {
			return fmt.Errorf("crvserver_rewritepolicy_binding %s not found", n)
		}
...
func testAccCheckCrvserver_rewritepolicy_bindingNotExist(n string, id string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		if found {
			return fmt.Errorf("crvserver_rewritepolicy_binding %s was found, but it should have been destroyed", n)
		}
