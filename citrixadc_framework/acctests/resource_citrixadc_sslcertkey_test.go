...
resource "citrixadc_systemfile" "cert_file" {
  filename = "servercert11.cert"
  filelocation = "/nsconfig/ssl"
  filecontent = file("./testdata/servercert_init/servercert11.cert")
}

resource "citrixadc_systemfile" "key_file" {
  filename = "servercert11.key"
  filelocation = "/nsconfig/ssl"
  filecontent = file("./testdata/servercert_init/servercert11.key")
}

resource "citrixadc_sslcertkey" "foo" {
  certkey = "sample_ssl_cert"
  cert = "/nsconfig/ssl/servercert11.cert"
  key = "/nsconfig/ssl/servercert11.key"
  notificationperiod = 40
  expirymonitor = "ENABLED"
...
resource "citrixadc_systemfile" "cert_file" {
  filename = "servercert11.cert"
  filelocation = "/nsconfig/ssl"
  filecontent = file("./testdata/servercert_latest/servercert11.cert")
}

resource "citrixadc_systemfile" "key_file" {
  filename = "servercert11.key"
  filelocation = "/nsconfig/ssl"
  filecontent = file("./testdata/servercert_latest/servercert11.key")
}
