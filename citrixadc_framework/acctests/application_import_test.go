...
// NOTE on the application_import resource:
...
const testAccApplicationImport_basic = `
resource "citrixadc_application_import" "tf_application" {
...
func TestAccApplicationImport_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccApplicationImport_basic,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckApplicationImportExist("citrixadc_application_import.tf_application", nil),
					// "id" is set to appname after a successful ?action=Import.
					resource.TestCheckResourceAttrSet("citrixadc_application_import.tf_application", "id"),
					// Assert the attributes actually set in HCL.
					resource.TestCheckResourceAttr("citrixadc_application_import.tf_application", "appname", "tf_test_application"),
					...
					resource.TestCheckResourceAttr("citrixadc_application_import.tf_application", "apptemplatefilename", "TODO_PLACEHOLDER"),
				),
			},
		},
	})
...
// testAccCheckApplicationImportExist is a STATE-ONLY existence check.
//
// application_import is an action-only resource: Read is a no-op and there is NO
...
func testAccCheckApplicationImportExist(n string, id *string) resource.TestCheckFunc {
