...
func testAccCheckAuthenticationnegotiatepolicyExist(n string, id *string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		data, err := client.FindResource(service.Authenticationnegotiatepolicy.Type(), rs.Primary.ID)
...
func testAccCheckAuthenticationnegotiatepolicyDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		...
		_, err := client.FindResource(service.Authenticationnegotiatepolicy.Type(), rs.Primary.ID)
		if err == nil {
