...
const testAccAppfwprofile_jsoncmdurl_binding_upgrade_basic = `
	resource "citrixadc_appfwprofile" "tf_appfwprofile" {
		name = "tf_appfwprofile"
		type = ["HTML"]
	}
...
func TestAccAppfwprofile_jsoncmdurl_binding_import(t *testing.T) {
	const resAddr = "citrixadc_appfwprofile_jsoncmdurl_binding.tf_binding"

	// Backward-compat: import via the LEGACY SDK v2 id. Rebuild the legacy positional id from
	// the current canonical key:value id (raw values, only the keys actually set, in legacy
	// order: name,jsoncmdurl,keyname_json_cmd,as_value_type_json_cmd,as_value_expr_json_cmd) so it matches exactly what SDK v2 wrote.
	legacyID := func(s *terraform.State) (string, error) {
		...
		ordr := []string{"name", "jsoncmdurl", "keyname_json_cmd", "as_value_type_json_cmd", "as_value_expr_json_cmd"}
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{Config: testAccAppfwprofile_jsoncmdurl_binding_basic},
			{Config: testAccAppfwprofile_jsoncmdurl_binding_basic, ResourceName: resAddr, ImportState: true, ImportStateVerify: true, ImportStateVerifyIgnore: []string{"alertonly", "isautodeployed"}},
			{Config: testAccAppfwprofile_jsoncmdurl_binding_basic, ResourceName: resAddr, ImportState: true, ImportStateIdFunc: legacyID, ImportStateVerify: true, ImportStateVerifyIgnore: []string{"alertonly", "isautodeployed"}},
		},
	})
}

func TestAccAppfwprofile_jsoncmdurl_binding_sdkv2StateUpgrade(t *testing.T) {
	resource.Test(t, resource.TestCase{
		PreCheck:     func() { testAccPreCheck(t) },
		CheckDestroy: testAccCheckAppfwprofile_jsoncmdurl_bindingDestroy,
		Steps: []resource.TestStep{
			{
				...
				Config: testAccAppfwprofile_jsoncmdurl_binding_upgrade_basic,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAppfwprofile_jsoncmdurl_bindingExist("citrixadc_appfwprofile_jsoncmdurl_binding.tf_binding", nil),
					resource.TestCheckResourceAttr("citrixadc_appfwprofile_jsoncmdurl_binding.tf_binding", "id", "tf_appfwprofile,^https://sd2\\-zgw\\.test\\.ctxns\\.com/api/document/content$"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAppfwprofile_jsoncmdurl_bindingExist("citrixadc_appfwprofile_jsoncmdurl_binding.tf_binding", nil),
					resource.TestCheckResourceAttr("citrixadc_appfwprofile_jsoncmdurl_binding.tf_binding", "id", "name:tf_appfwprofile,jsoncmdurl:%5Ehttps%3A%2F%2Fsd2%5C-zgw%5C.test%5C.ctxns%5C.com%2Fapi%2Fdocument%2Fcontent%24"),
				),
			},
		},
	})
