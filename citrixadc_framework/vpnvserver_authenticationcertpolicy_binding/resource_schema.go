...
func vpnvserver_authenticationcertpolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *VpnvserverAuthenticationcertpolicyBindingResourceModel) vpn.Vpnvserverauthenticationcertpolicybinding {
	tflog.Debug(ctx, "In vpnvserver_authenticationcertpolicy_bindingGetThePayloadFromtheConfig Function")
