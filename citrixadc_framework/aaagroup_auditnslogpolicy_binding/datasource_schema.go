...
// AaagroupAuditnslogpolicyBindingDataSourceModel is the data-source-specific
...
type AaagroupAuditnslogpolicyBindingDataSourceModel struct {
	...
	// (zion73x_readonly/aaagroup_auditnslogpolicy_binding.json).
	Acttype types.Int64 `tfsdk:"acttype"`
}

func AaagroupAuditnslogpolicyBindingDataSourceSchema() schema.Schema {
...
// aaagroup_auditnslogpolicy_bindingDataSourceSetAttrFromGet projects a NITRO GET
...
func aaagroup_auditnslogpolicy_bindingDataSourceSetAttrFromGet(ctx context.Context, data *AaagroupAuditnslogpolicyBindingDataSourceModel, g map[string]interface{}) {
	tflog.Debug(ctx, "In aaagroup_auditnslogpolicy_bindingDataSourceSetAttrFromGet Function")
