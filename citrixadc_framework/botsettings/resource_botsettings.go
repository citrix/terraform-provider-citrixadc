...
var _ resource.ResourceWithUpgradeState = &BotsettingsResource{}
...
func (r *BotsettingsResource) UpgradeState(ctx context.Context) map[int64]resource.StateUpgrader {
