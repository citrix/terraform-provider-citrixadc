...
var _ resource.ResourceWithUpgradeState = &RdpclientprofileResource{}
...
func (r *RdpclientprofileResource) UpgradeState(ctx context.Context) map[int64]resource.StateUpgrader {
