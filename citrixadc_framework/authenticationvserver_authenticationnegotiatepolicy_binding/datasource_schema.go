...
// AuthenticationvserverAuthenticationnegotiatepolicyBindingDataSourceModel is
...
type AuthenticationvserverAuthenticationnegotiatepolicyBindingDataSourceModel struct {
	...
	// (zion73x_readonly/authenticationvserver_authenticationnegotiatepolicy_binding.json).
	// Never settable; populated from GET.
	Acttype types.Int64 `tfsdk:"acttype"`
}

func AuthenticationvserverAuthenticationnegotiatepolicyBindingDataSourceSchema() schema.Schema {
...
// authenticationvserver_authenticationnegotiatepolicy_bindingDataSourceSetAttrFromGet
...
func authenticationvserver_authenticationnegotiatepolicy_bindingDataSourceSetAttrFromGet(ctx context.Context, data *AuthenticationvserverAuthenticationnegotiatepolicyBindingDataSourceModel, g map[string]interface{}) {
	tflog.Debug(ctx, "In authenticationvserver_authenticationnegotiatepolicy_bindingDataSourceSetAttrFromGet Function")
