...
func authenticationvserver_auditsyslogpolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *AuthenticationvserverAuditsyslogpolicyBindingResourceModel) authentication.Authenticationvserverauditsyslogpolicybinding {
	tflog.Debug(ctx, "In authenticationvserver_auditsyslogpolicy_bindingGetThePayloadFromtheConfig Function")
