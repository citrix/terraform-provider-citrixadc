...
var _ resource.ResourceWithUpgradeState = &AaatacacsparamsResource{}
...
func (r *AaatacacsparamsResource) UpgradeState(ctx context.Context) map[int64]resource.StateUpgrader {
