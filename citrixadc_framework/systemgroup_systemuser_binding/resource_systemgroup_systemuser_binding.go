...
var _ resource.Resource = &SystemgroupSystemuserBindingResource{}
var _ resource.ResourceWithConfigure = (*SystemgroupSystemuserBindingResource)(nil)
var _ resource.ResourceWithImportState = (*SystemgroupSystemuserBindingResource)(nil)

func NewSystemgroupSystemuserBindingResource() resource.Resource {
	return &SystemgroupSystemuserBindingResource{}
}

// SystemgroupSystemuserBindingResource defines the resource implementation.
type SystemgroupSystemuserBindingResource struct {
	client *service.NitroClient
}

func (r *SystemgroupSystemuserBindingResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	resource.ImportStatePassthroughID(ctx, path.Root("id"), req, resp)
}

func (r *SystemgroupSystemuserBindingResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_systemgroup_systemuser_binding"
}

func (r *SystemgroupSystemuserBindingResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *SystemgroupSystemuserBindingResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if data.Id.IsNull() {
		resp.Diagnostics.AddError("Client Error", "systemgroup_systemuser_binding not found on the ADC immediately after create")
		return
	}
...
func (r *SystemgroupSystemuserBindingResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data SystemgroupSystemuserBindingResourceModel
	...
	tflog.Debug(ctx, "Reading systemgroup_systemuser_binding resource")
...
func (r *SystemgroupSystemuserBindingResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if data.Id.IsNull() {
		resp.Diagnostics.AddError("Client Error", "systemgroup_systemuser_binding not found on the ADC immediately after update")
		return
	}
...
func (r *SystemgroupSystemuserBindingResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data SystemgroupSystemuserBindingResourceModel
