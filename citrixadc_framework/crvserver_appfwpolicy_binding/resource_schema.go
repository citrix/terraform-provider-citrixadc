...
func (r *CrvserverAppfwpolicyBindingResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func crvserver_appfwpolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *CrvserverAppfwpolicyBindingResourceModel) cr.Crvserverappfwpolicybinding {
	tflog.Debug(ctx, "In crvserver_appfwpolicy_bindingGetThePayloadFromtheConfig Function")
	...
	if !data.Invoke.IsNull() {
		crvserver_appfwpolicy_binding.Invoke = data.Invoke.ValueBool()
	}
	if !data.Labelname.IsNull() {
		crvserver_appfwpolicy_binding.Labelname = data.Labelname.ValueString()
	}
	if !data.Labeltype.IsNull() {
		crvserver_appfwpolicy_binding.Labeltype = data.Labeltype.ValueString()
	}
	if !data.Name.IsNull() {
		crvserver_appfwpolicy_binding.Name = data.Name.ValueString()
	}
	if !data.Policyname.IsNull() {
		crvserver_appfwpolicy_binding.Policyname = data.Policyname.ValueString()
	}
	if !data.Priority.IsNull() {
		crvserver_appfwpolicy_binding.Priority = utils.IntPtr(int(data.Priority.ValueInt64()))
	}
	if !data.Targetvserver.IsNull() {
		crvserver_appfwpolicy_binding.Targetvserver = data.Targetvserver.ValueString()
	}
