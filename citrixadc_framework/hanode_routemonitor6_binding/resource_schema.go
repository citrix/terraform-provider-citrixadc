...
func hanode_routemonitor6_bindingGetThePayloadFromtheConfig(ctx context.Context, data *HanodeRoutemonitor6BindingResourceModel) ha.Hanoderoutemonitor6binding {
	tflog.Debug(ctx, "In hanode_routemonitor6_bindingGetThePayloadFromtheConfig Function")
