...
// AaauserTmsessionpolicyBindingResourceModel describes the resource data model.
type AaauserTmsessionpolicyBindingResourceModel struct {
...
func (r *AaauserTmsessionpolicyBindingResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func aaauser_tmsessionpolicy_bindingGetThePayloadFromtheConfig(ctx context.Context, data *AaauserTmsessionpolicyBindingResourceModel) aaa.Aaausertmsessionpolicybinding {
	...
	return aaauser_tmsessionpolicy_binding
}

func aaauser_tmsessionpolicy_bindingSetAttrFromGet(ctx context.Context, data *AaauserTmsessionpolicyBindingResourceModel, getResponseData map[string]interface{}) *AaauserTmsessionpolicyBindingResourceModel {
