...
// AaauserVpntrafficpolicyBindingDataSourceModel is the data-source-specific model.
...
// (zion73x_readonly/aaauser_vpntrafficpolicy_binding.json). All non-key
...
type AaauserVpntrafficpolicyBindingDataSourceModel struct {
...
func AaauserVpntrafficpolicyBindingDataSourceSchema() schema.Schema {
...
// aaauser_vpntrafficpolicy_bindingDataSourceSetAttrFromGet projects a NITRO
// aaauser_vpntrafficpolicy_binding GET response onto the data-source model. A
...
// helpers.
func aaauser_vpntrafficpolicy_bindingDataSourceSetAttrFromGet(ctx context.Context, data *AaauserVpntrafficpolicyBindingDataSourceModel, g map[string]interface{}) {
	tflog.Debug(ctx, "In aaauser_vpntrafficpolicy_bindingDataSourceSetAttrFromGet Function")
