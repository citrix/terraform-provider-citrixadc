...
func (r *VideooptimizationdetectionpolicylabelVideooptimizationdetectionpolicyBindingResource) readVideooptimizationdetectionpolicylabelVideooptimizationdetectionpolicyBindingFromApi(ctx context.Context, data *VideooptimizationdetectionpolicylabelVideooptimizationdetectionpolicyBindingResourceModel, diags *diag.Diagnostics) {
	...
	// Resource is missing
	if len(dataArr) == 0 {
		diags.AddError("Client Error", "videooptimizationdetectionpolicylabel_videooptimizationdetectionpolicy_binding returned empty array.")
		return
	}
	...
	//  Resource is missing
	if foundIndex == -1 {
		diags.AddError("Client Error", fmt.Sprintf("videooptimizationdetectionpolicylabel_videooptimizationdetectionpolicy_binding not found with the provided ID attributes"))
		return
	}
