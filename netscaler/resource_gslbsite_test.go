		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckGslbsiteExist("netscaler_gslbsite.foo", nil),

					resource.TestCheckResourceAttr(
						"netscaler_gslbsite.foo", "siteipaddress", "172.31.11.20"),
					resource.TestCheckResourceAttr(
						"netscaler_gslbsite.foo", "sitename", "Site-GSLB-East-Coast"),
				),
			},
		},
	})
