		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckInatExist("netscaler_inat.foo", nil),

					resource.TestCheckResourceAttr(
						"netscaler_inat.foo", "name", "ip4ip"),
					resource.TestCheckResourceAttr(
						"netscaler_inat.foo", "privateip", "192.168.1.1"),
					resource.TestCheckResourceAttr(
						"netscaler_inat.foo", "publicip", "172.16.1.2"),
					resource.TestCheckResourceAttr(
						"netscaler_inat.foo", "tcpproxy", "ENABLED"),
					resource.TestCheckResourceAttr(
						"netscaler_inat.foo", "usnip", "ON"),
				),
			},
		},
	})
