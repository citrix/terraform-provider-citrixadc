...
func TestAccRewritepolicy_basic(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccRewritepolicy_basic,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckRewritepolicyExist("citrixadc_rewritepolicy.foo", nil),
				),
			},
		},
	})
...
const testAccRewritepolicy_basic = `


resource "citrixadc_rewritepolicy" "foo" {
