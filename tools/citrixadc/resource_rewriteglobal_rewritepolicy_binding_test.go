		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckRewriteglobal_rewritepolicy_bindingExist("citrixadc_rewriteglobal_rewritepolicy_binding.foo", nil),
				),
			},
		},
	})
...
func testAccCheckRewriteglobal_rewritepolicy_bindingExist(n string, id *string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		data, err := nsClient.FindResource(netscaler.Rewriteglobal_rewritepolicy_binding.Type(), rs.Primary.ID)
...
func testAccCheckRewriteglobal_rewritepolicy_bindingDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		...
		_, err := nsClient.FindResource(netscaler.Rewriteglobal_rewritepolicy_binding.Type(), rs.Primary.ID)
		if err == nil {
...
resource "citrixadc_rewriteglobal_rewritepolicy_binding" "foo" {
