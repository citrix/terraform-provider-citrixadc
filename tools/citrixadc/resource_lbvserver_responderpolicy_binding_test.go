...
func TestAccLbvserver_responderpolicy_binding_basic(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccLbvserver_responderpolicy_binding_basic,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckLbvserver_responderpolicy_bindingExist("citrixadc_lbvserver_responderpolicy_binding.foo", nil),
				),
			},
		},
	})
...
func testAccCheckLbvserver_responderpolicy_bindingExist(n string, id *string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		data, err := nsClient.FindResource(netscaler.Lbvserver_responderpolicy_binding.Type(), rs.Primary.ID)
...
const testAccLbvserver_responderpolicy_binding_basic = `


resource "citrixadc_lbvserver_responderpolicy_binding" "foo" {
