...
func TestAccResponderaction_basic(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccResponderaction_basic,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckResponderactionExist("citrixadc_responderaction.foo", nil),
				),
			},
		},
	})
...
const testAccResponderaction_basic = `


resource "citrixadc_responderaction" "foo" {
