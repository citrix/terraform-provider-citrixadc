		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("citrixadc_appfwprofile_jsonxssurl_binding.tf_binding", "jsonxssurl", "www.example.com"),
					resource.TestCheckResourceAttr("citrixadc_appfwprofile_jsonxssurl_binding.tf_binding2", "name", "tf_appfwprofile"),
					resource.TestCheckResourceAttr("citrixadc_appfwprofile_jsonxssurl_binding.tf_binding2", "jsonxssurl", "www.example.com"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckAppfwprofile_jsonxssurl_bindingNotExist("citrixadc_appfwprofile_jsonxssurl_binding.tf_binding2", "tf_appfwprofile,www.example.com,id,EXPR,http.req.url.path"),
				),
			},
		},
	})
