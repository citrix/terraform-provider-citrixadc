...
const testAccSpilloverpolicy_basic = `
	resource "citrixadc_spilloverpolicy" "foo" {
		action = "spillover"
    	comment = "spillover"
...
func TestAccSpilloverpolicy_basic(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccSpilloverpolicy_basic,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSpilloverpolicyExist("citrixadc_spilloverpolicy.foo", nil),
				),
			},
		},
	})
