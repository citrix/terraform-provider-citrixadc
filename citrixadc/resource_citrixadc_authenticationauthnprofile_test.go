...
func testAccCheckAuthenticationauthnprofileExist(n string, id *string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		data, err := nsClient.FindResource(service.Authenticationauthnprofile.Type(), rs.Primary.ID)
...
func testAccCheckAuthenticationauthnprofileDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		...
		_, err := nsClient.FindResource(service.Authenticationauthnprofile.Type(), rs.Primary.ID)
		if err == nil {
