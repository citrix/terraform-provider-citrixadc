...
func resourceCitrixAdcVpnvserver_vpnsessionpolicy_binding() *schema.Resource {
	return &schema.Resource{
		SchemaVersion: 1,
		Create:        createVpnvserver_vpnsessionpolicy_bindingFunc,
		Read:          readVpnvserver_vpnsessionpolicy_bindingFunc,
		Delete:        deleteVpnvserver_vpnsessionpolicy_bindingFunc,
...
func createVpnvserver_vpnsessionpolicy_bindingFunc(d *schema.ResourceData, meta interface{}) error {
	...
	err = readVpnvserver_vpnsessionpolicy_bindingFunc(d, meta)
	if err != nil {
		log.Printf("[ERROR] netscaler-provider: ?? we just created this vpnvserver_vpnsessionpolicy_binding but we can't read it ?? vpnvserver_vpnsessionpolicy_binding")
		return nil
	}
	return nil
}

func readVpnvserver_vpnsessionpolicy_bindingFunc(d *schema.ResourceData, meta interface{}) error {
...
func deleteVpnvserver_vpnsessionpolicy_bindingFunc(d *schema.ResourceData, meta interface{}) error {
