...
func resourceCitrixAdcCsvserver_tmtrafficpolicy_binding() *schema.Resource {
	return &schema.Resource{
		SchemaVersion: 1,
		Create:        createCsvserver_tmtrafficpolicy_bindingFunc,
		Read:          readCsvserver_tmtrafficpolicy_bindingFunc,
		Delete:        deleteCsvserver_tmtrafficpolicy_bindingFunc,
...
func createCsvserver_tmtrafficpolicy_bindingFunc(d *schema.ResourceData, meta interface{}) error {
	...
	err = readCsvserver_tmtrafficpolicy_bindingFunc(d, meta)
	if err != nil {
		log.Printf("[ERROR] netscaler-provider: ?? we just created this csvserver_tmtrafficpolicy_binding but we can't read it ?? %s", bindingId)
		return nil
	}
	return nil
}

func readCsvserver_tmtrafficpolicy_bindingFunc(d *schema.ResourceData, meta interface{}) error {
...
func deleteCsvserver_tmtrafficpolicy_bindingFunc(d *schema.ResourceData, meta interface{}) error {
