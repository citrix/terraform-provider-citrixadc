...
func resourceCitrixAdcCrvserver_lbvserver_binding() *schema.Resource {
	return &schema.Resource{
		SchemaVersion: 1,
		Create:        createCrvserver_lbvserver_bindingFunc,
		Read:          readCrvserver_lbvserver_bindingFunc,
		Delete:        deleteCrvserver_lbvserver_bindingFunc,
...
func createCrvserver_lbvserver_bindingFunc(d *schema.ResourceData, meta interface{}) error {
	...
	err = readCrvserver_lbvserver_bindingFunc(d, meta)
	if err != nil {
		log.Printf("[ERROR] netscaler-provider: ?? we just created this crvserver_lbvserver_binding but we can't read it ?? %s", bindingId)
		return nil
	}
	return nil
}

func readCrvserver_lbvserver_bindingFunc(d *schema.ResourceData, meta interface{}) error {
...
func deleteCrvserver_lbvserver_bindingFunc(d *schema.ResourceData, meta interface{}) error {
