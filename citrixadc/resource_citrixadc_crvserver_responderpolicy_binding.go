...
func resourceCitrixAdcCrvserver_responderpolicy_binding() *schema.Resource {
	return &schema.Resource{
		SchemaVersion: 1,
		Create:        createCrvserver_responderpolicy_bindingFunc,
		Read:          readCrvserver_responderpolicy_bindingFunc,
		Delete:        deleteCrvserver_responderpolicy_bindingFunc,
...
func createCrvserver_responderpolicy_bindingFunc(d *schema.ResourceData, meta interface{}) error {
	...
	err = readCrvserver_responderpolicy_bindingFunc(d, meta)
	if err != nil {
		log.Printf("[ERROR] netscaler-provider: ?? we just created this crvserver_responderpolicy_binding but we can't read it ?? %s", bindingId)
		return nil
	}
	return nil
}

func readCrvserver_responderpolicy_bindingFunc(d *schema.ResourceData, meta interface{}) error {
...
func deleteCrvserver_responderpolicy_bindingFunc(d *schema.ResourceData, meta interface{}) error {
