		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAppfwjsoncontenttypeExist("citrixadc_appfwjsoncontenttype.tf_Acc_appfwjsoncontenttype", nil),
					resource.TestCheckResourceAttr("citrixadc_appfwjsoncontenttype.tf_Acc_appfwjsoncontenttype", "jsoncontenttypevalue", "tf_Acc.*test"),
				),
			},
		},
	})
...
func testAccCheckAppfwjsoncontenttypeExist(n string, id *string) resource.TestCheckFunc {
