...
func testAccCheckAuditsyslogactionExist(n string, id *string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		data, err := nsClient.FindResource(netscaler.Auditsyslogaction.Type(), rs.Primary.ID)
...
func testAccCheckAuditsyslogactionDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		...
		_, err := nsClient.FindResource(netscaler.Auditsyslogaction.Type(), rs.Primary.ID)
		if err == nil {
